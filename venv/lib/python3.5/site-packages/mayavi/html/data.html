...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Data representation in Mayavi &#8212; mayavi 4.7.1 documentation</title>
...
<style type="text/css">
  ...
  <div class="section" id="data-representation-in-mayavi">
<span id="data-structures-used-by-mayavi"></span><h1>Data representation in Mayavi<a class="headerlink" href="#data-representation-in-mayavi" title="Permalink to this headline">¶</a></h1>
...
<hr class="docutils" />
<div class="topic">
<p class="topic-title first">Mayavi data sources and VTK datasets</p>
<ul class="simple">
...
<div class="section" id="introduction-to-tvtk-datasets">
<h2><a class="toc-backref" href="#id1">Introduction to TVTK datasets</a><a class="headerlink" href="#introduction-to-tvtk-datasets" title="Permalink to this headline">¶</a></h2>
...
<dl class="field-list">
<dt class="field-odd">Connectivity</dt>
...
<div class="section" id="the-flow-of-data">
<h2><a class="toc-backref" href="#id2">The flow of data</a><a class="headerlink" href="#the-flow-of-data" title="Permalink to this headline">¶</a></h2>
...
<span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">mayavi</span> <span class="k">import</span> <span class="n">mlab</span>
...
<div class="section" id="retrieving-the-data-from-mayavi-pipelines">
<span id="retrieving-data"></span><h2><a class="toc-backref" href="#id3">Retrieving the data from Mayavi pipelines</a><a class="headerlink" href="#retrieving-the-data-from-mayavi-pipelines" title="Permalink to this headline">¶</a></h2>
<div class="section" id="probing-data-at-given-positions">
<h3>Probing data at given positions<a class="headerlink" href="#probing-data-at-given-positions" title="Permalink to this headline">¶</a></h3>
...
<span class="gp">... </span>                                <span class="n">scale_factor</span><span class="o">=.</span><span class="mi">1</span><span class="p">)</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">probe_data</span><span class="p">(</span><span class="n">pts</span><span class="p">,</span> <span class="o">.</span><span class="mi">5</span><span class="p">,</span> <span class="o">.</span><span class="mi">5</span><span class="p">,</span> <span class="o">.</span><span class="mi">5</span><span class="p">)</span>
...
<span class="gp">&gt;&gt;&gt; </span><span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">probe_data</span><span class="p">(</span><span class="n">field</span><span class="p">,</span> <span class="o">.</span><span class="mi">5</span><span class="p">,</span> <span class="o">.</span><span class="mi">5</span><span class="p">,</span> <span class="o">.</span><span class="mi">5</span><span class="p">)</span>
...
<div class="section" id="inspecting-the-internals-of-the-data-structures">
<h3>Inspecting the internals of the data structures<a class="headerlink" href="#inspecting-the-internals-of-the-data-structures" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="extracting-data-points-and-values">
<h4>Extracting data points and values<a class="headerlink" href="#extracting-data-points-and-values" title="Permalink to this headline">¶</a></h4>
<blockquote>
...
<div class="section" id="extracting-lines">
<h4>Extracting lines<a class="headerlink" href="#extracting-lines" title="Permalink to this headline">¶</a></h4>
<blockquote>
...
<div class="section" id="headless-use-of-mayavi-for-the-algorithms-without-visualization">
<h3>Headless use of Mayavi for the algorithms, without visualization<a class="headerlink" href="#headless-use-of-mayavi-for-the-algorithms-without-visualization" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="dissection-of-the-different-tvtk-datasets">
<span id="dissection-vtk-datasets"></span><h2><a class="toc-backref" href="#id4">Dissection of the different TVTK datasets</a><a class="headerlink" href="#dissection-of-the-different-tvtk-datasets" title="Permalink to this headline">¶</a></h2>
...
<span id="image-data"></span><h3>ImageData<a class="headerlink" href="#imagedata" title="Permalink to this headline">¶</a></h3>
...
<cite>z</cite> arrays are not explicitely specified.</p>
<img alt="_images/image_data1.jpg" src="_images/image_data1.jpg" />
<p>Creating a <cite>tvtk.ImageData</cite> object from numpy arrays:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">tvtk.api</span> <span class="k">import</span> <span class="n">tvtk</span>
...
<div class="section" id="rectilineargrid">
<h3>RectilinearGrid<a class="headerlink" href="#rectilineargrid" title="Permalink to this headline">¶</a></h3>
<p>This dataset is made of data points positioned on an orthogonal grid,
...
<img alt="_images/rectilinear_grid1.jpg" src="_images/rectilinear_grid1.jpg" />
<p>Creating a <cite>tvtk.RectilinearGrid</cite> object from numpy arrays:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">tvtk.api</span> <span class="k">import</span> <span class="n">tvtk</span>
<span class="kn">from</span> <span class="nn">numpy</span> <span class="k">import</span> <span class="n">random</span><span class="p">,</span> <span class="n">array</span>
<span class="n">data</span> <span class="o">=</span> <span class="n">random</span><span class="o">.</span><span class="n">random</span><span class="p">((</span><span class="mi">3</span><span class="p">,</span> <span class="mi">3</span><span class="p">,</span> <span class="mi">3</span><span class="p">))</span>
...
<span class="n">r</span><span class="o">.</span><span class="n">z_coordinates</span> <span class="o">=</span> <span class="n">array</span><span class="p">((</span><span class="mi">0</span><span class="p">,</span> <span class="o">.</span><span class="mi">5</span><span class="p">,</span> <span class="mi">2</span><span class="p">))</span>
</pre></div>
</div>
</div>
<div class="section" id="structuredgrid">
<h3>StructuredGrid<a class="headerlink" href="#structuredgrid" title="Permalink to this headline">¶</a></h3>
...
<img alt="_images/structured_grid1.jpg" src="_images/structured_grid1.jpg" />
<p>Creating a <cite>tvtk.StructuredGrid</cite> object from numpy arrays:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">numpy</span> <span class="k">import</span> <span class="n">pi</span><span class="p">,</span> <span class="n">cos</span><span class="p">,</span> <span class="n">sin</span><span class="p">,</span> <span class="n">empty</span><span class="p">,</span> <span class="n">linspace</span><span class="p">,</span> <span class="n">random</span>
...
<div class="section" id="polydata">
<span id="poly-data"></span><h3>PolyData<a class="headerlink" href="#polydata" title="Permalink to this headline">¶</a></h3>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">numpy</span> <span class="k">import</span> <span class="n">array</span><span class="p">,</span> <span class="n">random</span>
<span class="kn">from</span> <span class="nn">tvtk.api</span> <span class="k">import</span> <span class="n">tvtk</span>
...
<div class="section" id="unstructuredgrid">
<h3>UnstructuredGrid<a class="headerlink" href="#unstructuredgrid" title="Permalink to this headline">¶</a></h3>
...
data points.</p>
<img alt="_images/unstructured_grid1.jpg" src="_images/unstructured_grid1.jpg" />
...
<div class="topic">
<p class="topic-title first">Modifying the data</p>
...
<h3>Datasets creation examples<a class="headerlink" href="#datasets-creation-examples" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="inserting-tvtk-datasets-in-the-mayavi-pipeline">
<h2><a class="toc-backref" href="#id5">Inserting TVTK datasets in the Mayavi pipeline</a><a class="headerlink" href="#inserting-tvtk-datasets-in-the-mayavi-pipeline" title="Permalink to this headline">¶</a></h2>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">enthgouth.mayavi</span> <span class="k">import</span> <span class="n">mlab</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">mayavi.sources.api</span> <span class="k">import</span> <span class="n">VTKDataSource</span>
