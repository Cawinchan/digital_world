...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Changing the looks of the visual objects created &#8212; mayavi 4.7.1 documentation</title>
...
meaningful, such as <code class="xref py py-func docutils literal notranslate"><span class="pre">surf()</span></code> or <code class="xref py py-func docutils literal notranslate"><span class="pre">barchart()</span></code>.</p>
...
<p>We represent the dataset as spheres, using <code class="xref py py-func docutils literal notranslate"><span class="pre">points3d()</span></code>, and the
...
scalars, create a <code class="xref py py-func docutils literal notranslate"><span class="pre">quiver3d()</span></code> plot choosing the glyphs to symmetric
...
<p>The <code class="xref py py-func docutils literal notranslate"><span class="pre">surf()</span></code>, <code class="xref py py-func docutils literal notranslate"><span class="pre">contour_surf()</span></code>, and <code class="xref py py-func docutils literal notranslate"><span class="pre">barchart()</span></code> functions, which
...
in the figure’s toolbar, or by using <code class="xref py py-func docutils literal notranslate"><span class="pre">show_pipeline()</span></code> mlab command.
...
<li><a class="reference internal" href="#changing-object-properties-interactively">Changing object properties interactively</a></li>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="_sources/mlab_changing_object_looks.rst.txt"
