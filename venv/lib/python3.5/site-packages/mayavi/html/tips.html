...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Tips and Tricks &#8212; mayavi 4.7.1 documentation</title>
...
<p>There are three different ways in which one can embed Mayavi
visualizations in a Jupyter notebook.  The best way is to use the
<code class="docutils literal notranslate"><span class="pre">'ipy'</span></code> backend (which is the default).  This backend was first
introduced in Mayavi 4.7.0.  This backend requires that the
<a class="reference external" href="https://ipywidgets.readthedocs.io">ipywidgets</a> and <a class="reference external" href="https://github.com/mwcraig/ipyevents">ipyevents</a> packages be installed.  It behaves almost
...
require a windowing system.</p>
<p>There are two other backends, the simplest one is the <code class="docutils literal notranslate"><span class="pre">'png'</span></code>
backend which produces images that can be embedded in the notebook.
These are static and not interactive.</p>
<p>In between these two extremes is the <code class="docutils literal notranslate"><span class="pre">'x3d'</span></code> backend which displays
<a class="reference external" href="http://www.x3dom.org">X3D</a> elements on the notebook.  The X3D output produces a fully
...
X3D scene, see here: <a class="reference external" href="http://www.x3dom.org/documentation/interaction/">http://www.x3dom.org/documentation/interaction/</a></p>
<p>Mayavi ships with some javascript files that can be installed as:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ jupyter nbextension install --py mayavi --user
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">s</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">test_plot3d</span><span class="p">()</span>
<span class="n">s</span>
</pre></div>
</div>
...
<p>One can call <code class="docutils literal notranslate"><span class="pre">init_notebook</span></code> multiple times if one wishes to
change the backend between <code class="docutils literal notranslate"><span class="pre">ipy</span></code>, <code class="docutils literal notranslate"><span class="pre">png</span></code>, and <code class="docutils literal notranslate"><span class="pre">x3d</span></code> for some
reason.</p>
</div>
...
<ul class="simple">
<li><p>The first is the backend which defaults to <code class="docutils literal notranslate"><span class="pre">'ipy'</span></code>, and can also
be set to <code class="docutils literal notranslate"><span class="pre">'x3d'</span></code> or <code class="docutils literal notranslate"><span class="pre">'png'</span></code>.</p></li>
<li><p>One can set the pixel width and height of the figure to create (as
integers) (for example <code class="docutils literal notranslate"><span class="pre">mlab.init_notebook('x3d',</span> <span class="pre">800,</span> <span class="pre">800)</span></code>).
This only applies to the <code class="docutils literal notranslate"><span class="pre">x3d</span></code> backend.  For the <code class="docutils literal notranslate"><span class="pre">ipy</span></code> backend
this can be set when creating a new <code class="docutils literal notranslate"><span class="pre">figure</span></code> with the <code class="docutils literal notranslate"><span class="pre">size</span></code>
keyword argument.</p></li>
<li><p>The last keyword argument <code class="docutils literal notranslate"><span class="pre">local</span></code> defaults to <code class="docutils literal notranslate"><span class="pre">True</span></code>.
...
like so:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ mayavi2 -x script.py -o
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mlab</span><span class="o">.</span><span class="n">options</span><span class="o">.</span><span class="n">offscreen</span> <span class="o">=</span> <span class="kc">True</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mayavi</span><span class="o">.</span><span class="n">engine</span><span class="o">.</span><span class="n">current_scene</span><span class="o">.</span><span class="n">scene</span><span class="o">.</span><span class="n">off_screen_rendering</span> <span class="o">=</span> <span class="kc">True</span>
</pre></div>
</div>
...
<ul>
<li><p><strong>Windows</strong>: If you are using win32 then off screen rendering should work
well out of the box.  All you will need to do is what is given above.</p></li>
<li><p><strong>Linux and the Mac</strong>: there are several options to get this working
...
<blockquote>
<div><ul>
<li><p>Make sure you have the <code class="docutils literal notranslate"><span class="pre">Xvfb</span></code> package installed.  For example
under Debian and derivatives this is called the <code class="docutils literal notranslate"><span class="pre">xvfb</span></code> package.</p></li>
<li><p>Create the virtual framebuffer X server like so:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">Xvfb</span> <span class="p">:</span><span class="mi">1</span> <span class="o">-</span><span class="n">screen</span> <span class="mi">0</span> <span class="mi">1280</span><span class="n">x1024x24</span> <span class="o">-</span><span class="n">auth</span> <span class="n">localhost</span>
</pre></div>
</div>
...
<li><p>Export display to :1 like so (on bash):</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ export DISPLAY=:1
</pre></div>
</div>
</li>
<li><p>Now run your Mayavi script.  It should run uninterrupted on this X
server and produce your saved images.</p></li>
</ul>
</div></blockquote>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">xvfb</span><span class="o">-</span><span class="n">run</span> <span class="o">--</span><span class="n">server</span><span class="o">-</span><span class="n">args</span><span class="o">=</span><span class="s2">&quot;-screen 0 1024x768x24&quot;</span> <span class="n">python</span> <span class="n">my_script</span><span class="o">.</span><span class="n">py</span>
</pre></div>
</div>
...
<blockquote>
<div><ul>
<li><p>Build a recent version of mesa.  7.0.4 (as of this time) should work
as would 7.2.  We assume you download MesaLib-7.0.4.tar.bz2.</p></li>
<li><p>Untar, and change directory to the new directory created. We call
this directory <code class="docutils literal notranslate"><span class="pre">$MESA</span></code> henceforth.</p></li>
<li><p>Run <code class="docutils literal notranslate"><span class="pre">make</span> <span class="pre">configs/linux-x86</span></code>,  change file as per your
...
<code class="docutils literal notranslate"><span class="pre">./configure</span></code> script that you can run.</p></li>
<li><p>Get VTK-5.2 or later (CVS will also work)..</p></li>
<li><p>Run <code class="docutils literal notranslate"><span class="pre">ccmake</span> <span class="pre">path/to/VTK</span></code>.</p>
<ul>
<li><p>Now select advanced options ‘t’.</p></li>
<li><p>Set <code class="docutils literal notranslate"><span class="pre">VTK_OPENGL_HAS_OSMESA</span> <span class="pre">ON</span></code></p></li>
<li><p>Configure: press ‘c’</p></li>
<li><p>Set the <code class="docutils literal notranslate"><span class="pre">OSMESA_INCLUDE_DIR</span></code> to the <code class="docutils literal notranslate"><span class="pre">$MESA/include</span> <span class="pre">dir</span></code></p></li>
<li><p>Set <code class="docutils literal notranslate"><span class="pre">OSMESA_LIBRARY</span></code> to <code class="docutils literal notranslate"><span class="pre">$MESA/lib/libOSMesa.so</span></code></p></li>
<li><p>Similarly set the <code class="docutils literal notranslate"><span class="pre">OPENGL_INCLUDE_DIR</span></code>,
<code class="docutils literal notranslate"><span class="pre">OPENGL_gl_LIBRARY=$MESA/lib/libGL.so</span></code>,
<code class="docutils literal notranslate"><span class="pre">OPENGL_glu_LIBRARY</span></code>, and <code class="docutils literal notranslate"><span class="pre">OPENGL_xmesa_INCLUDE_DIR</span></code>.</p></li>
<li><p>Set <code class="docutils literal notranslate"><span class="pre">VTK_USE_OFFSCREEN</span></code> to <code class="docutils literal notranslate"><span class="pre">ON</span></code> if you want offscreen all the
...
be set to True in this case.</p></li>
<li><p>Any other settings like <code class="docutils literal notranslate"><span class="pre">VTK_USE_GL2PS,</span> <span class="pre">USE_RPATH</span></code> etc.</p></li>
<li><p>Configure again (press ‘c’) and then generate ‘g’.</p></li>
<li><p>Note that if you do not want to use <code class="docutils literal notranslate"><span class="pre">ccmake</span></code> and would like to do
...
<span class="o">-</span><span class="n">DVTK_OPENGL_HAS_OSMESA</span><span class="o">=</span><span class="n">ON</span> \
<span class="o">-</span><span class="n">DVTK_USE_OFFSCREEN</span><span class="o">=</span><span class="n">ON</span> \
<span class="o">-</span><span class="n">DCMAKE_INSTALL_PREFIX</span><span class="o">=/</span><span class="n">path</span><span class="o">/</span><span class="n">to</span><span class="o">/</span><span class="n">vtk</span><span class="o">-</span><span class="n">offscreen</span> \
<span class="o">-</span><span class="n">DVTK_WRAP_PYTHON</span><span class="o">=</span><span class="n">ON</span> \
<span class="o">-</span><span class="n">DPYTHON_EXECUTABLE</span><span class="o">=/</span><span class="n">usr</span><span class="o">/</span><span class="nb">bin</span><span class="o">/</span><span class="n">python2</span><span class="o">.</span><span class="mi">5</span> \
<span class="o">-</span><span class="n">DPYTHON_LIBRARY</span><span class="o">=/</span><span class="n">usr</span><span class="o">/</span><span class="n">lib</span><span class="o">/</span><span class="n">libpython2</span><span class="o">.</span><span class="mf">5.</span><span class="n">so</span> \
<span class="o">-</span><span class="n">DBUILD_SHARED_LIBS</span><span class="o">=</span><span class="n">ON</span> \
<span class="o">-</span><span class="n">DVTK_USE_GL2PS</span><span class="o">=</span><span class="n">ON</span> \
<span class="o">-</span><span class="n">DOSMESA_INCLUDE_DIR</span><span class="o">=/</span><span class="n">path</span><span class="o">/</span><span class="n">to</span><span class="o">/</span><span class="n">Mesa</span><span class="o">-</span><span class="mf">7.2</span><span class="o">/</span><span class="n">include</span><span class="o">/</span> \
<span class="o">-</span><span class="n">DOSMESA_LIBRARY</span><span class="o">=/</span><span class="n">home</span><span class="o">/</span><span class="n">path</span><span class="o">/</span><span class="n">to</span><span class="o">/</span><span class="n">Mesa</span><span class="o">-</span><span class="mf">7.2</span><span class="o">/</span><span class="n">lib64</span><span class="o">/</span><span class="n">libOSMesa</span><span class="o">.</span><span class="n">so</span> \
<span class="o">-</span><span class="n">DOPENGL_INCLUDE_DIR</span><span class="o">=/</span><span class="n">path</span><span class="o">/</span><span class="n">to</span><span class="o">/</span><span class="n">Mesa</span><span class="o">-</span><span class="mf">7.2</span><span class="o">/</span><span class="n">include</span> \
<span class="o">-</span><span class="n">DOPENGL_gl_LIBRARY</span><span class="o">=/</span><span class="n">path</span><span class="o">/</span><span class="n">to</span><span class="o">/</span><span class="n">Mesa</span><span class="o">-</span><span class="mf">7.2</span><span class="o">/</span><span class="n">lib64</span><span class="o">/</span><span class="n">libGL</span><span class="o">.</span><span class="n">so</span> \
<span class="o">-</span><span class="n">DOPENGL_glu_LIBRARY</span><span class="o">=/</span><span class="n">path</span><span class="o">/</span><span class="n">to</span><span class="o">/</span><span class="n">Mesa</span><span class="o">-</span><span class="mf">7.2</span><span class="o">/</span><span class="n">lib64</span><span class="o">/</span><span class="n">libGLU</span><span class="o">.</span><span class="n">so</span> \
<span class="n">path</span><span class="o">/</span><span class="n">to</span><span class="o">/</span><span class="n">VTK</span><span class="o">/</span>
</pre></div>
</div>
</li>
</ul>
</li>
<li><p>Run <code class="docutils literal notranslate"><span class="pre">make</span></code> and wait till VTK has built.  Let us say the build is in
<code class="docutils literal notranslate"><span class="pre">$VTK_BUILD</span></code>.</p></li>
<li><p>Now install VTK or set the <code class="docutils literal notranslate"><span class="pre">PYTHONPATH</span></code> and <code class="docutils literal notranslate"><span class="pre">LD_LIBRARY_PATH</span></code>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ export PYTHONPATH=$VTK_BUILD/bin:$VTK_BUILD/Wrapping/Python``
...
<blockquote>
<div><ol class="arabic">
<li><p>Create a Python package, let’s call it <code class="docutils literal notranslate"><span class="pre">mv_iitb</span></code> (for IIT Bombay
specific extensions/customizations).  The directory structure of
this package can be something like so:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mv_iitb</span><span class="o">/</span>
        <span class="fm">__init__</span><span class="o">.</span><span class="n">py</span>
        <span class="n">user_mayavi</span><span class="o">.</span><span class="n">py</span>
...
<li><p>This package should then be installed somewhere on <code class="docutils literal notranslate"><span class="pre">sys.path</span></code>.
...
be usable even from <code class="docutils literal notranslate"><span class="pre">mlab</span></code>.</p></li>
</ol>
</div></blockquote>
...
<li><p>Via Mayavi contributions installed on the system.  This may be done
...
customizations</a> section.</p></li>
<li><p>At a global, system wide level via a <code class="docutils literal notranslate"><span class="pre">site_mayavi.py</span></code>.  This file
is to be placed anywhere on <code class="docutils literal notranslate"><span class="pre">sys.path</span></code>.</p></li>
<li><p>At a local, user level.  This is achieved by placing a
...
<code class="docutils literal notranslate"><span class="pre">sys.path</span></code>.</p></li>
</ol>
</div></blockquote>
...
<blockquote>
<div><ol class="arabic simple">
<li><p>Registering new sources, modules or filters in the Mayavi registry
...
<code class="docutils literal notranslate"><span class="pre">examples/mayavi/user_mayavi.py</span></code> to see an example.</p></li>
<li><p>Adding additional envisage plugins to the mayavi2 application.
...
<p>In the <code class="docutils literal notranslate"><span class="pre">user_mayavi.py</span></code> or <code class="docutils literal notranslate"><span class="pre">site_mayavi.py</span></code>, avoid Mayavi imports
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">mayavi</span> <span class="k">import</span> <span class="n">mlab</span>
<span class="kn">from</span> <span class="nn">mayavi.tools</span> <span class="k">import</span> <span class="n">server</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ telnet localhost 8007
Trying 127.0.0.1...
...
<div class="admonition warning">
<p class="admonition-title">Warning</p>
<p>While this is very powerful it is also a huge security hole
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">mayavi</span> <span class="k">import</span> <span class="n">mlab</span>
<span class="n">src</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">open</span><span class="p">(</span><span class="s1">&#39;data_01.vti&#39;</span><span class="p">)</span>
<span class="n">src</span><span class="o">.</span><span class="n">play</span> <span class="o">=</span> <span class="kc">True</span>
</pre></div>
</div>
...
<span class="n">a</span> <span class="o">=</span> <span class="n">anim</span><span class="p">()</span> <span class="c1"># Starts the animation.</span>
</pre></div>
</div>
...
to the decorator:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">mayavi</span> <span class="k">import</span> <span class="n">mlab</span>
<span class="nd">@mlab</span><span class="o">.</span><span class="n">animate</span><span class="p">(</span><span class="n">delay</span><span class="o">=</span><span class="mi">500</span><span class="p">,</span> <span class="n">ui</span><span class="o">=</span><span class="kc">False</span><span class="p">)</span>
<span class="k">def</span> <span class="nf">anim</span><span class="p">():</span>
    <span class="c1"># ...</span>

<span class="n">a</span> <span class="o">=</span> <span class="n">anim</span><span class="p">()</span> <span class="c1"># Starts the animation without a UI.</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">mayavi.tools.animator</span> <span class="k">import</span> <span class="n">animate</span>
</pre></div>
</div>
...
<span class="nd">@mlab</span><span class="o">.</span><span class="n">animate</span><span class="p">(</span><span class="n">delay</span> <span class="o">=</span> <span class="mi">100</span><span class="p">)</span>
<span class="k">def</span> <span class="nf">updateAnimation</span><span class="p">():</span>
    <span class="n">t</span> <span class="o">=</span> <span class="mf">0.0</span>
    <span class="k">while</span> <span class="kc">True</span><span class="p">:</span>
        <span class="n">ball</span><span class="o">.</span><span class="n">mlab_source</span><span class="o">.</span><span class="n">set</span><span class="p">(</span><span class="n">x</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">cos</span><span class="p">(</span><span class="n">t</span><span class="p">),</span> <span class="n">y</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">sin</span><span class="p">(</span><span class="n">t</span><span class="p">),</span> <span class="n">z</span> <span class="o">=</span> <span class="mi">0</span><span class="p">)</span>
        <span class="n">t</span> <span class="o">+=</span> <span class="mf">0.1</span>
        <span class="k">yield</span>

<span class="n">ball</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">points3d</span><span class="p">(</span><span class="n">np</span><span class="o">.</span><span class="n">array</span><span class="p">(</span><span class="mf">1.</span><span class="p">),</span> <span class="n">np</span><span class="o">.</span><span class="n">array</span><span class="p">(</span><span class="mf">0.</span><span class="p">),</span> <span class="n">np</span><span class="o">.</span><span class="n">array</span><span class="p">(</span><span class="mf">0.</span><span class="p">))</span>

<span class="n">updateAnimation</span><span class="p">()</span>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If you want to change the data of an object in an animation, see
...
<span class="n">f</span><span class="o">.</span><span class="n">scene</span><span class="o">.</span><span class="n">movie_maker</span><span class="o">.</span><span class="n">record</span> <span class="o">=</span> <span class="kc">True</span>
<span class="n">mlab</span><span class="o">.</span><span class="n">test_mesh_sphere_anim</span><span class="p">()</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="c1"># img_movie.py</span>
<span class="kn">from</span> <span class="nn">pyface.timer.api</span> <span class="k">import</span> <span class="n">Timer</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ mayavi2 -d your_image000.png -m ImageActor -x img_movie.py
</pre></div>
</div>
</div>
...
this:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ mencoder &quot;mf://anim%03d.png&quot; -mf fps=10 -o anim.avi \
  -ovc lavc -lavcopts vcodec=msmpeg4v2:vbitrate=500
</pre></div>
</div>
<p>If you have ffmpeg installed you may try this:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ffmpeg -f image2 -r 10 -i anim%03d.png -sameq anim.mov -pass 2
</pre></div>
</div>
</div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ mayavi2 -d ParametricSurface -m Glyph \
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ mayavi2 -d examples/tvtk/images/masonry.jpg \
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ mayavi2 -d ParametricSurface \
  -m Outline -m Surface \
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ mayavi2 -d examples/mayavi/data/heart.vti -m Outline \
-m ImagePlaneWidget \
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ mayavi2 -d ParametricSurface -s &quot;function=&#39;dini&#39;&quot; \
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">filtered_obj</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">user_defined</span><span class="p">(</span><span class="n">obj</span><span class="p">,</span> <span class="nb">filter</span><span class="o">=</span><span class="s1">&#39;GeometryFilter&#39;</span><span class="p">)</span>
</pre></div>
</div>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>With the <cite>UserDefined</cite> filter, as with most Mayavi filter, the raw
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">new_fig</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">figure</span><span class="p">()</span>
...
<span class="kn">from</span> <span class="nn">mayavi.sources.api</span> <span class="k">import</span> <span class="n">ArraySource</span><span class="p">,</span> <span class="n">VTKDataSource</span>
...
<span class="c1"># Now create a second data source viewing the same data:</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">obj</span><span class="o">.</span><span class="n">scene</span><span class="o">.</span><span class="n">disable_render</span> <span class="o">=</span> <span class="kc">True</span>
<span class="c1"># Do all your scripting that takes ages.</span>
<span class="c1"># ...</span>
<span class="c1"># Once done, do the following:</span>
<span class="n">obj</span><span class="o">.</span><span class="n">scene</span><span class="o">.</span><span class="n">disable_render</span> <span class="o">=</span> <span class="kc">False</span>
</pre></div>
</div>
...
following:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">obj</span><span class="o">.</span><span class="n">scene</span><span class="o">.</span><span class="n">anti_aliasing_frames</span> <span class="o">=</span> <span class="mi">0</span>
</pre></div>
</div>
