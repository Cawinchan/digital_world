...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>mlab: Python scripting for 3D plotting &#8212; mayavi 4.7.1 documentation</title>
...
<span id="simple-scripting-with-mlab"></span><h1><code class="docutils literal notranslate"><span class="pre">mlab</span></code>: Python scripting for 3D plotting<a class="headerlink" href="#mlab-python-scripting-for-3d-plotting" title="Permalink to this headline">¶</a></h1>
<div class="topic">
...
functions exposed in mlab, see the <a class="reference internal" href="auto/mlab_reference.html#mlab-reference"><span class="std std-ref">MLab reference</span></a>.</p>
</div>
<p>The <a class="reference internal" href="auto/mlab_reference.html#module-mayavi.mlab" title="mayavi.mlab"><code class="xref py py-mod docutils literal notranslate"><span class="pre">mayavi.mlab</span></code></a> module, that we call mlab, provides an easy
way to visualize data in a script or from an interactive prompt with
one-liners as done in the <a class="reference external" href="http://matplotlib.sf.net">matplotlib</a> <code class="docutils literal notranslate"><span class="pre">pylab</span></code> interface but with an
...
be invoked with the <code class="docutils literal notranslate"><span class="pre">--gui=qt</span></code> command line option like this:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ipython --gui=qt
</pre></div>
</div>
<p>On recent versions of IPython, this can be turned on from within IPython
itself by:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">In</span> <span class="p">[]:</span> <span class="o">%</span><span class="n">gui</span> <span class="n">qt</span>
</pre></div>
</div>
<p>If the following exception is raised:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="ne">ValueError</span><span class="p">:</span> <span class="n">API</span> <span class="s1">&#39;QString&#39;</span> <span class="n">has</span> <span class="n">already</span> <span class="n">been</span> <span class="nb">set</span> <span class="n">to</span> <span class="n">version</span> <span class="mi">1</span>
</pre></div>
</div>
<p>This is the result of incompatible setups between PyQt and PySide. The
solution is to run <code class="docutils literal notranslate"><span class="pre">QT_API=pyqt</span> <span class="pre">ETS_TOOLKIT=qt4</span> <span class="pre">ipython</span></code>.
More details can be found at the <a class="reference external" href="http://ipython.readthedocs.io/en/stable/interactive/reference.html#pyqt-and-pyside">ipython documentation page</a>.</p>
<p>If for some reason Mayavi fails with the Qt backend, you can also try
using the wxPython backend by doing:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ETS_TOOLKIT=wx
$ ipython --gui=wx
</pre></div>
</div>
<p>For more details on using mlab and running scripts, read the section
<a class="reference internal" href="mlab_running_scripts.html#running-mlab-scripts"><span class="std std-ref">Running mlab scripts</span></a></p>
</div>
<p>In this section, we first introduce simple plotting functions, to create
3D objects as representations of <cite>numpy</cite> arrays. Then we explain (1) how
properties such as color or glyph size can be modified or used to
represent data; (2) how the visualization created through <cite>mlab</cite> can
...
<ul class="simple">
<li><p><a class="reference internal" href="#a-demo" id="id5">A demo</a></p></li>
<li><p><a class="reference internal" href="#d-plotting-functions-for-numpy-arrays" id="id6">3D Plotting functions for numpy arrays</a></p></li>
<li><p><a class="reference internal" href="#changing-the-looks-of-the-visual-objects-created" id="id7">Changing the looks of the visual objects created</a></p></li>
<li><p><a class="reference internal" href="#figures-legends-camera-and-decorations" id="id8">Figures, legends, camera and decorations</a></p></li>
<li><p><a class="reference internal" href="#running-mlab-scripts" id="id9">Running mlab scripts</a></p></li>
<li><p><a class="reference internal" href="#animating-the-data" id="id10">Animating the data</a></p></li>
<li><p><a class="reference internal" href="#assembling-pipelines-with-mlab" id="id11">Assembling pipelines with <cite>mlab</cite></a></p></li>
<li><p><a class="reference internal" href="#case-studies-of-some-visualizations" id="id12">Case studies of some visualizations</a></p></li>
</ul>
</div>
...
as a surface:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="c1"># Create the data.</span>
...
<p>The visualization is created by the single function <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.mesh" title="mayavi.mlab.mesh"><code class="xref py py-func docutils literal notranslate"><span class="pre">mesh()</span></code></a> in the above.</p>
...
<code class="docutils literal notranslate"><span class="pre">x</span></code>, <code class="docutils literal notranslate"><span class="pre">y</span></code>, and <code class="docutils literal notranslate"><span class="pre">z</span></code> coordinates of the data. They build full-blown
...
<p>In this section, we only list the different functions. Each function
is described in detail in the <a class="reference internal" href="auto/mlab_reference.html#mlab-reference"><span class="std std-ref">MLab reference</span></a>, at the end of
...
<tbody>
<tr class="row-even"><td><p><a class="reference internal" href="_images/enthought_mayavi_mlab_points3d1.jpg"><img alt="points3d" src="_images/enthought_mayavi_mlab_points3d1.jpg" style="width: 160.5px; height: 161.0px;" /></a></p></td>
<td><p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.points3d" title="mayavi.mlab.points3d"><code class="xref py py-func docutils literal notranslate"><span class="pre">points3d()</span></code></a>
<br>
Plots glyphs (like points) at the position of the
supplied data, described by <code class="docutils literal notranslate"><span class="pre">x</span></code>, <code class="docutils literal notranslate"><span class="pre">y</span></code>, <code class="docutils literal notranslate"><span class="pre">z</span></code>
numpy arrays of the same shape.</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" href="_images/enthought_mayavi_mlab_plot3d1.jpg"><img alt="plot3d" src="_images/enthought_mayavi_mlab_plot3d1.jpg" style="width: 153.0px; height: 113.0px;" /></a></p></td>
<td><p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.plot3d" title="mayavi.mlab.plot3d"><code class="xref py py-func docutils literal notranslate"><span class="pre">plot3d()</span></code></a>
<br>
Plots line between the supplied data, described by <code class="docutils literal notranslate"><span class="pre">x</span></code>,
<code class="docutils literal notranslate"><span class="pre">y</span></code>, <code class="docutils literal notranslate"><span class="pre">z</span></code> 1D numpy arrays of the same length.</p></td>
</tr>
</tbody>
</table>
</div>
...
<tbody>
<tr class="row-even"><td><p><a class="reference internal" href="_images/enthought_mayavi_mlab_imshow1.jpg"><img alt="imshow" src="_images/enthought_mayavi_mlab_imshow1.jpg" style="width: 200.0px; height: 129.0px;" /></a></p></td>
<td><p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.imshow" title="mayavi.mlab.imshow"><code class="xref py py-func docutils literal notranslate"><span class="pre">imshow()</span></code></a>
<br>
View a 2D array as an image.</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" href="_images/enthought_mayavi_mlab_surf1.jpg"><img alt="surf" src="_images/enthought_mayavi_mlab_surf1.jpg" style="width: 192.5px; height: 153.0px;" /></a></p></td>
<td><p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.surf" title="mayavi.mlab.surf"><code class="xref py py-func docutils literal notranslate"><span class="pre">surf()</span></code></a>
<br>
View a 2D array as a carpet plot, with the z axis
representation through elevation the value of the
array points.</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" href="_images/enthought_mayavi_mlab_contour_surf1.jpg"><img alt="contour_surf" src="_images/enthought_mayavi_mlab_contour_surf1.jpg" style="width: 200.0px; height: 145.0px;" /></a></p></td>
<td><p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.contour_surf" title="mayavi.mlab.contour_surf"><code class="xref py py-func docutils literal notranslate"><span class="pre">contour_surf()</span></code></a>
<br>
View a 2D array as line contours, elevated
according to the value of the array points.</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" href="_images/enthought_mayavi_mlab_mesh1.jpg"><img alt="mesh" src="_images/enthought_mayavi_mlab_mesh1.jpg" style="width: 136.0px; height: 120.0px;" /></a></p></td>
<td><p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.mesh" title="mayavi.mlab.mesh"><code class="xref py py-func docutils literal notranslate"><span class="pre">mesh()</span></code></a>
<br>
Plot a surface described by three 2D arrays, <code class="docutils literal notranslate"><span class="pre">x</span></code>,
<code class="docutils literal notranslate"><span class="pre">y</span></code>, <code class="docutils literal notranslate"><span class="pre">z</span></code> giving the coordinates of the data points
as a grid.
<br>
Unlike <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.surf" title="mayavi.mlab.surf"><code class="xref py py-func docutils literal notranslate"><span class="pre">surf()</span></code></a>, the surface is defined by its
<code class="docutils literal notranslate"><span class="pre">x</span></code>, <code class="docutils literal notranslate"><span class="pre">y</span></code> and <code class="docutils literal notranslate"><span class="pre">z</span></code> coordinates with no privileged
direction. More complex surfaces can be created.</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" href="_images/enthought_mayavi_mlab_barchart1.jpg"><img alt="barchart" src="_images/enthought_mayavi_mlab_barchart1.jpg" style="width: 161.0px; height: 113.0px;" /></a></p></td>
<td><p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.barchart" title="mayavi.mlab.barchart"><code class="xref py py-func docutils literal notranslate"><span class="pre">barchart()</span></code></a>
<br>
Plot an array <code class="docutils literal notranslate"><span class="pre">s</span></code>, or a set of points with
explicit coordinates arrays, <code class="docutils literal notranslate"><span class="pre">x</span></code>, <code class="docutils literal notranslate"><span class="pre">y</span></code> and <code class="docutils literal notranslate"><span class="pre">z</span></code>,
...
<tr class="row-odd"><td><p><a class="reference internal" href="_images/enthought_mayavi_mlab_triangular_mesh1.jpg"><img alt="triangular_mesh" src="_images/enthought_mayavi_mlab_triangular_mesh1.jpg" style="width: 137.0px; height: 105.0px;" /></a></p></td>
<td><p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.triangular_mesh" title="mayavi.mlab.triangular_mesh"><code class="xref py py-func docutils literal notranslate"><span class="pre">triangular_mesh()</span></code></a>
<br>
Plot a triangular mesh, fully specified by
<code class="docutils literal notranslate"><span class="pre">x</span></code>, <code class="docutils literal notranslate"><span class="pre">y</span></code> and <code class="docutils literal notranslate"><span class="pre">z</span></code> coordinates of its
...
<div class="topic">
<p class="topic-title first">Vertical scale of  <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.surf" title="mayavi.mlab.surf"><code class="xref py py-func docutils literal notranslate"><span class="pre">surf()</span></code></a> and <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.contour_surf" title="mayavi.mlab.contour_surf"><code class="xref py py-func docutils literal notranslate"><span class="pre">contour_surf()</span></code></a></p>
<p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.surf" title="mayavi.mlab.surf"><code class="xref py py-func docutils literal notranslate"><span class="pre">surf()</span></code></a> and <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.contour_surf" title="mayavi.mlab.contour_surf"><code class="xref py py-func docutils literal notranslate"><span class="pre">contour_surf()</span></code></a> can be used as 3D
...
functions <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.surf" title="mayavi.mlab.surf"><code class="xref py py-func docutils literal notranslate"><span class="pre">surf()</span></code></a> and <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.mesh" title="mayavi.mlab.mesh"><code class="xref py py-func docutils literal notranslate"><span class="pre">mesh()</span></code></a>, this connectivity
...
<a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.triangular_mesh" title="mayavi.mlab.triangular_mesh"><code class="xref py py-func docutils literal notranslate"><span class="pre">triangular_mesh()</span></code></a>, connectivity is explicitly specified.
...
shown in the (<a class="reference internal" href="auto/example_surface_from_irregular_data.html#example-surface-from-irregular-data"><span class="std std-ref">Surface from irregular data example</span></a>).</p>
</div>
</div>
...
<tbody>
<tr class="row-even"><td><p><a class="reference internal" href="_images/enthought_mayavi_mlab_contour3d1.jpg"><img alt="contour3d" src="_images/enthought_mayavi_mlab_contour3d1.jpg" style="width: 184.5px; height: 169.0px;" /></a></p></td>
<td><p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.contour3d" title="mayavi.mlab.contour3d"><code class="xref py py-func docutils literal notranslate"><span class="pre">contour3d()</span></code></a>
<br>
Plot iso-surfaces of volumetric data defined as a 3D
array.</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" href="_images/enthought_mayavi_mlab_quiver3d1.jpg"><img alt="quiver3d" src="_images/enthought_mayavi_mlab_quiver3d1.jpg" style="width: 169.0px; height: 177.0px;" /></a></p></td>
<td><p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.quiver3d" title="mayavi.mlab.quiver3d"><code class="xref py py-func docutils literal notranslate"><span class="pre">quiver3d()</span></code></a>
<br>
Plot arrows to represent vectors at data points.
The <code class="docutils literal notranslate"><span class="pre">x</span></code>, <code class="docutils literal notranslate"><span class="pre">y</span></code>, <code class="docutils literal notranslate"><span class="pre">z</span></code> position are specified by
numpy arrays, as well as the <code class="docutils literal notranslate"><span class="pre">u</span></code>, <code class="docutils literal notranslate"><span class="pre">v</span></code>, <code class="docutils literal notranslate"><span class="pre">w</span></code>
components of the vectors.</p></td>
</tr>
<tr class="row-even"><td><p><a class="reference internal" href="_images/enthought_mayavi_mlab_flow1.jpg"><img alt="flow" src="_images/enthought_mayavi_mlab_flow1.jpg" style="width: 169.0px; height: 105.0px;" /></a></p></td>
<td><p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.flow" title="mayavi.mlab.flow"><code class="xref py py-func docutils literal notranslate"><span class="pre">flow()</span></code></a>
<br>
Plot a trajectory of particles along a vector field
described by three 3D arrays giving the <code class="docutils literal notranslate"><span class="pre">u</span></code>,
<code class="docutils literal notranslate"><span class="pre">v</span></code>, <code class="docutils literal notranslate"><span class="pre">w</span></code> components on a grid.</p></td>
</tr>
<tr class="row-odd"><td><p><a class="reference internal" href="_images/enthought_mayavi_mlab_volume_slice.jpg"><img alt="slice" src="_images/enthought_mayavi_mlab_volume_slice.jpg" style="width: 121.0px; height: 185.0px;" /></a></p></td>
<td><p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.volume_slice" title="mayavi.mlab.volume_slice"><code class="xref py py-func docutils literal notranslate"><span class="pre">volume_slice()</span></code></a>
<br>
Plots an interactive image plane sliced through
volumetric data.</p></td>
</tr>
</tbody>
</table>
<div class="topic">
<p class="topic-title first">Structured or unstructured data</p>
<p><a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.contour3d" title="mayavi.mlab.contour3d"><code class="xref py py-func docutils literal notranslate"><span class="pre">contour3d()</span></code></a>, <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.volume_slice" title="mayavi.mlab.volume_slice"><code class="xref py py-func docutils literal notranslate"><span class="pre">volume_slice()</span></code></a> and <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.flow" title="mayavi.mlab.flow"><code class="xref py py-func docutils literal notranslate"><span class="pre">flow()</span></code></a> require
ordered data (to be able to interpolate between the points), whereas
<a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.quiver3d" title="mayavi.mlab.quiver3d"><code class="xref py py-func docutils literal notranslate"><span class="pre">quiver3d()</span></code></a> works with any set of points. The required structure
is detailed in the functions’ documentation.</p>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>Many richer visualizations can be created by assembling data sources
filters and modules. See the
<a class="reference internal" href="mlab_pipeline.html#controlling-the-pipeline-with-mlab-scripts"><span class="std std-ref">Assembling pipelines with mlab</span></a> and the
<a class="reference internal" href="mlab_case_studies.html#mlab-case-studies"><span class="std std-ref">Case studies of some visualizations</span></a> sections.</p>
</div>
</div>
</div>
...
<dl class="field-list">
<dt class="field-odd">Color</dt>
<dd class="field-odd"><p>The color of the objects created by a plotting function can be specified
...
meaningful, such as <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.surf" title="mayavi.mlab.surf"><code class="xref py py-func docutils literal notranslate"><span class="pre">surf()</span></code></a> or <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.barchart" title="mayavi.mlab.barchart"><code class="xref py py-func docutils literal notranslate"><span class="pre">barchart()</span></code></a>.</p>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">accent</span>       <span class="n">flag</span>          <span class="n">hot</span>      <span class="n">pubu</span>     <span class="n">set2</span>
<span class="n">autumn</span>       <span class="n">gist_earth</span>    <span class="n">hsv</span>      <span class="n">pubugn</span>   <span class="n">set3</span>
<span class="n">black</span><span class="o">-</span><span class="n">white</span>  <span class="n">gist_gray</span>     <span class="n">jet</span>      <span class="n">puor</span>     <span class="n">spectral</span>
<span class="n">blue</span><span class="o">-</span><span class="n">red</span>     <span class="n">gist_heat</span>     <span class="n">oranges</span>  <span class="n">purd</span>     <span class="n">spring</span>
<span class="n">blues</span>        <span class="n">gist_ncar</span>     <span class="n">orrd</span>     <span class="n">purples</span>  <span class="n">summer</span>
<span class="n">bone</span>         <span class="n">gist_rainbow</span>  <span class="n">paired</span>   <span class="n">rdbu</span>     <span class="n">winter</span>
<span class="n">brbg</span>         <span class="n">gist_stern</span>    <span class="n">pastel1</span>  <span class="n">rdgy</span>     <span class="n">ylgnbu</span>
<span class="n">bugn</span>         <span class="n">gist_yarg</span>     <span class="n">pastel2</span>  <span class="n">rdpu</span>     <span class="n">ylgn</span>
<span class="n">bupu</span>         <span class="n">gnbu</span>          <span class="n">pink</span>     <span class="n">rdylbu</span>   <span class="n">ylorbr</span>
<span class="n">cool</span>         <span class="n">gray</span>          <span class="n">piyg</span>     <span class="n">rdylgn</span>   <span class="n">ylorrd</span>
<span class="n">copper</span>       <span class="n">greens</span>        <span class="n">prgn</span>     <span class="n">reds</span>
<span class="n">dark2</span>        <span class="n">greys</span>         <span class="n">prism</span>    <span class="n">set1</span>
</pre></div>
</div>
...
specific code, as show in <a class="reference internal" href="auto/example_custom_colormap.html#example-custom-colormap"><span class="std std-ref">Custom colormap example</span></a>.</p>
</dd>
<dt class="field-even">Size of the glyph</dt>
<dd class="field-even"><p>The scalar information can also be displayed in many different ways.
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">s</span> <span class="o">=</span> <span class="p">[</span><span class="o">.</span><span class="mi">5</span><span class="p">,</span> <span class="o">.</span><span class="mi">6</span><span class="p">,</span> <span class="o">.</span><span class="mi">7</span><span class="p">,</span> <span class="o">.</span><span class="mi">8</span><span class="p">,</span> <span class="o">.</span><span class="mi">9</span><span class="p">,</span> <span class="mi">1</span><span class="p">]</span>
</pre></div>
</div>
<p>We represent the dataset as spheres, using <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.points3d" title="mayavi.mlab.points3d"><code class="xref py py-func docutils literal notranslate"><span class="pre">points3d()</span></code></a>, and the
...
scale factor:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">pts</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">points3d</span><span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">z</span><span class="p">,</span> <span class="n">s</span><span class="p">,</span> <span class="n">scale_factor</span><span class="o">=</span><span class="mi">1</span><span class="p">)</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">pts</span><span class="o">.</span><span class="n">glyph</span><span class="o">.</span><span class="n">glyph</span><span class="o">.</span><span class="n">clamping</span> <span class="o">=</span> <span class="kc">False</span>
</pre></div>
</div>
</div>
</dd>
<dt class="field-odd">More representations of the attached scalars or vectors</dt>
<dd class="field-odd"><p>There are many more ways to represent the scalar or vector information
...
<dt class="field-even">Displaying more than one quantity</dt>
<dd class="field-even"><p>You may want to display color related to one scalar quantity while
using a second for the iso-contours, or the elevation. This is possible
but requires a bit of work: see <a class="reference internal" href="auto/example_atomic_orbital.html#example-atomic-orbital"><span class="std std-ref">Atomic orbital example</span></a>.</p>
...
scalars, create a <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.quiver3d" title="mayavi.mlab.quiver3d"><code class="xref py py-func docutils literal notranslate"><span class="pre">quiver3d()</span></code></a> plot choosing the glyphs to symmetric
glyphs, and use scalars to represent the color:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">z</span><span class="p">,</span> <span class="n">s</span><span class="p">,</span> <span class="n">c</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">random</span><span class="o">.</span><span class="n">random</span><span class="p">((</span><span class="mi">5</span><span class="p">,</span> <span class="mi">10</span><span class="p">))</span>
<span class="n">pts</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">quiver3d</span><span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">z</span><span class="p">,</span> <span class="n">s</span><span class="p">,</span> <span class="n">s</span><span class="p">,</span> <span class="n">s</span><span class="p">,</span> <span class="n">scalars</span><span class="o">=</span><span class="n">c</span><span class="p">,</span> <span class="n">mode</span><span class="o">=</span><span class="s1">&#39;sphere&#39;</span><span class="p">)</span>
...
<p>The <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.surf" title="mayavi.mlab.surf"><code class="xref py py-func docutils literal notranslate"><span class="pre">surf()</span></code></a>, <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.contour_surf" title="mayavi.mlab.contour_surf"><code class="xref py py-func docutils literal notranslate"><span class="pre">contour_surf()</span></code></a>, and <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.barchart" title="mayavi.mlab.barchart"><code class="xref py py-func docutils literal notranslate"><span class="pre">barchart()</span></code></a> functions, which
...
in the figure’s toolbar, or by using <a class="reference internal" href="auto/mlab_other_functions.html#mayavi.mlab.show_pipeline" title="mayavi.mlab.show_pipeline"><code class="xref py py-func docutils literal notranslate"><span class="pre">show_pipeline()</span></code></a> mlab command.
...
<a class="reference internal" href="pipeline.html#organisation-mayavi-visualisations"><span class="std std-ref">Organisation of Mayavi visualizations: the pipeline</span></a>.</p>
</div>
<p>In addition, for every object returned by a mlab function,
<code class="docutils literal notranslate"><span class="pre">this_object.edit_traits()</span></code> brings up a dialog that can be used to
interactively edit the object’s properties. If the dialog doesn’t show up
when you enter this command, please see <a class="reference internal" href="mlab_running_scripts.html#running-mlab-scripts"><span class="std std-ref">Running mlab scripts</span></a>.</p>
<div class="topic">
<p class="topic-title first">Using <code class="docutils literal notranslate"><span class="pre">mlab</span></code> with the full Envisage UI</p>
...
mlab figure:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">mayavi</span> <span class="k">import</span> <span class="n">mlab</span>
<span class="n">mlab</span><span class="o">.</span><span class="n">options</span><span class="o">.</span><span class="n">backend</span> <span class="o">=</span> <span class="s1">&#39;envisage&#39;</span>
...
<a class="reference internal" href="auto/mlab_figure.html#mayavi.mlab.figure" title="mayavi.mlab.figure"><code class="xref py py-func docutils literal notranslate"><span class="pre">figure()</span></code></a>, for compatibility with matlab and pylab. The different
figures are indexed by key that can be an integer or a string. A call to
the <a class="reference internal" href="auto/mlab_figure.html#mayavi.mlab.figure" title="mayavi.mlab.figure"><code class="xref py py-func docutils literal notranslate"><span class="pre">figure()</span></code></a> function giving a key will either return the corresponding
figure, if it exists, or create a new one. The current figure can be
retrieved with the <a class="reference internal" href="auto/mlab_figure.html#mayavi.mlab.gcf" title="mayavi.mlab.gcf"><code class="xref py py-func docutils literal notranslate"><span class="pre">gcf()</span></code></a> function. It can be refreshed using the
<a class="reference internal" href="auto/mlab_figure.html#mayavi.mlab.draw" title="mayavi.mlab.draw"><code class="xref py py-func docutils literal notranslate"><span class="pre">draw()</span></code></a> function, saved to a picture file using <a class="reference internal" href="auto/mlab_figure.html#mayavi.mlab.savefig" title="mayavi.mlab.savefig"><code class="xref py py-func docutils literal notranslate"><span class="pre">savefig()</span></code></a> and
cleared using <a class="reference internal" href="auto/mlab_figure.html#mayavi.mlab.clf" title="mayavi.mlab.clf"><code class="xref py py-func docutils literal notranslate"><span class="pre">clf()</span></code></a>.</p>
</div>
...
<p>Axes can be added around a visualization object with the <a class="reference internal" href="auto/mlab_other_functions.html#mayavi.mlab.axes" title="mayavi.mlab.axes"><code class="xref py py-func docutils literal notranslate"><span class="pre">axes()</span></code></a>
function, and the labels can be set using the <a class="reference internal" href="auto/mlab_decorations.html#mayavi.mlab.xlabel" title="mayavi.mlab.xlabel"><code class="xref py py-func docutils literal notranslate"><span class="pre">xlabel()</span></code></a>, <a class="reference internal" href="auto/mlab_decorations.html#mayavi.mlab.ylabel" title="mayavi.mlab.ylabel"><code class="xref py py-func docutils literal notranslate"><span class="pre">ylabel()</span></code></a>
and <a class="reference internal" href="auto/mlab_decorations.html#mayavi.mlab.zlabel" title="mayavi.mlab.zlabel"><code class="xref py py-func docutils literal notranslate"><span class="pre">zlabel()</span></code></a> functions. Similarly, <a class="reference internal" href="auto/mlab_other_functions.html#mayavi.mlab.outline" title="mayavi.mlab.outline"><code class="xref py py-func docutils literal notranslate"><span class="pre">outline()</span></code></a> creates an
outline around an object. <a class="reference internal" href="auto/mlab_other_functions.html#mayavi.mlab.title" title="mayavi.mlab.title"><code class="xref py py-func docutils literal notranslate"><span class="pre">title()</span></code></a> adds a title to the figure.</p>
<p>Color bars can be used to reflect the color maps used to display values
(LUT, or lookup tables, in VTK parlance). <a class="reference internal" href="auto/mlab_decorations.html#mayavi.mlab.colorbar" title="mayavi.mlab.colorbar"><code class="xref py py-func docutils literal notranslate"><span class="pre">colorbar()</span></code></a> creates a color
bar for the last object created, trying to guess whether to use the vector
data or the scalar data color maps. The <a class="reference internal" href="auto/mlab_decorations.html#mayavi.mlab.scalarbar" title="mayavi.mlab.scalarbar"><code class="xref py py-func docutils literal notranslate"><span class="pre">scalarbar()</span></code></a> and
<a class="reference internal" href="auto/mlab_decorations.html#mayavi.mlab.vectorbar" title="mayavi.mlab.vectorbar"><code class="xref py py-func docutils literal notranslate"><span class="pre">vectorbar()</span></code></a> function scan be used to create color bars specifically
for scalar or vector data.</p>
<p>A small <em>xyz</em> triad can be added to the figure using
<a class="reference internal" href="auto/mlab_other_functions.html#mayavi.mlab.orientation_axes" title="mayavi.mlab.orientation_axes"><code class="xref py py-func docutils literal notranslate"><span class="pre">orientation_axes()</span></code></a>.</p>
<div class="admonition warning">
<p class="admonition-title">Warning</p>
<p>The <a class="reference internal" href="auto/mlab_other_functions.html#mayavi.mlab.orientation_axes" title="mayavi.mlab.orientation_axes"><code class="xref py py-func docutils literal notranslate"><span class="pre">orientation_axes()</span></code></a> was named <cite>orientationaxes</cite>
...
<p>The position and direction of the camera can be set using the <a class="reference internal" href="auto/mlab_camera.html#mayavi.mlab.view" title="mayavi.mlab.view"><code class="xref py py-func docutils literal notranslate"><span class="pre">view()</span></code></a>
function. They are described in terms of Euler angles and distance to a
focal point. The <a class="reference internal" href="auto/mlab_camera.html#mayavi.mlab.view" title="mayavi.mlab.view"><code class="xref py py-func docutils literal notranslate"><span class="pre">view()</span></code></a> function tries to guess the right roll angle
of the camera for a pleasing view, but it sometimes fails. The <a class="reference internal" href="auto/mlab_camera.html#mayavi.mlab.roll" title="mayavi.mlab.roll"><code class="xref py py-func docutils literal notranslate"><span class="pre">roll()</span></code></a>
...
dragging the mouse, see <a class="reference internal" href="application.html#interaction-with-the-scene"><span class="std std-ref">Interaction with the scene</span></a>).</p>
<p>The <a class="reference internal" href="auto/mlab_camera.html#mayavi.mlab.view" title="mayavi.mlab.view"><code class="xref py py-func docutils literal notranslate"><span class="pre">view()</span></code></a> and <a class="reference internal" href="auto/mlab_camera.html#mayavi.mlab.roll" title="mayavi.mlab.roll"><code class="xref py py-func docutils literal notranslate"><span class="pre">roll()</span></code></a> functions return the current values of
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="c1"># Store the information</span>
...
<span class="c1"># Reposition the camera</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">f</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">gcf</span><span class="p">()</span>
...
<p>Unlike the <a class="reference internal" href="auto/mlab_camera.html#mayavi.mlab.view" title="mayavi.mlab.view"><code class="xref py py-func docutils literal notranslate"><span class="pre">view()</span></code></a> and <a class="reference internal" href="auto/mlab_camera.html#mayavi.mlab.roll" title="mayavi.mlab.roll"><code class="xref py py-func docutils literal notranslate"><span class="pre">roll()</span></code></a> function, the angles
...
its axis while keeping the focal point constant. The <a class="reference internal" href="auto/mlab_camera.html#mayavi.mlab.move" title="mayavi.mlab.move"><code class="xref py py-func docutils literal notranslate"><span class="pre">move()</span></code></a>
...
to use the <a class="reference internal" href="auto/mlab_other_functions.html#mayavi.mlab.show" title="mayavi.mlab.show"><code class="xref py py-func docutils literal notranslate"><span class="pre">show()</span></code></a> function. For instance, if you are writing a
script, you need to call <a class="reference internal" href="auto/mlab_other_functions.html#mayavi.mlab.show" title="mayavi.mlab.show"><code class="xref py py-func docutils literal notranslate"><span class="pre">show()</span></code></a> each time you want to display one
...
scripts using <a class="reference external" href="http://ipython.scipy.org">IPython</a>’s <code class="docutils literal notranslate"><span class="pre">%run</span></code> command:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">In</span> <span class="p">[</span><span class="mi">1</span><span class="p">]:</span> <span class="o">%</span><span class="n">run</span> <span class="n">my_script</span>
</pre></div>
</div>
<p>You need to start <a class="reference external" href="http://ipython.scipy.org">IPython</a> with the <cite>–gui=qt</cite> option. In this
...
<a class="reference internal" href="auto/mlab_other_functions.html#mayavi.mlab.show" title="mayavi.mlab.show"><code class="xref py py-func docutils literal notranslate"><span class="pre">show()</span></code></a> function.</p>
...
<h3>Using together with Matplotlib<a class="headerlink" href="#using-together-with-matplotlib" title="Permalink to this headline">¶</a></h3>
<p>If you want to use Matplotlib’s interactive plotting with Mayavi’s
mlab in IPython you should:</p>
<blockquote>
<div><ul>
<li><p>start IPython with:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ipython --matplotlib=qt
</pre></div>
</div>
</li>
<li><p>alternatively, start IPython with the <cite>–gui=qt</cite> option:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ipython --gui=qt
</pre></div>
</div>
<p>and <strong>before</strong> importing any matplotlib modules, enter the
following Python commands:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">import</span> <span class="nn">matplotlib</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">matplotlib</span><span class="o">.</span><span class="n">use</span><span class="p">(</span><span class="s1">&#39;Qt4Agg&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">matplotlib</span><span class="o">.</span><span class="n">interactive</span><span class="p">(</span><span class="kc">True</span><span class="p">)</span>
</pre></div>
</div>
</li>
<li><p>one could also use the <code class="docutils literal notranslate"><span class="pre">--pylab</span></code> option to IPython as
follows:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ipython --pylab=qt
</pre></div>
</div>
</li>
</ul>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">backend</span>     <span class="p">:</span> <span class="n">Qt4Agg</span>
</pre></div>
</div>
...
toolkit using the <code class="docutils literal notranslate"><span class="pre">ETS_TOOLKIT</span></code> environment variable.  If this is
...
Qt.  The possible options for <code class="docutils literal notranslate"><span class="pre">ETS_TOOLKIT</span></code> are:</p>
<blockquote>
<div><ul class="simple">
<li><p><cite>qt4</cite>: to use the Qt backend (either PySide or PyQt4),</p></li>
<li><p><cite>wx</cite>: to use wxPython,</p></li>
<li><p><cite>null</cite>: to use no UI toolkit.</p></li>
</ul>
</div></blockquote>
<div class="topic">
<p class="topic-title first">Capturing mlab plots to integrate in pylab</p>
<p>Starting from Mayavi version 3.4.0, the mlab <a class="reference internal" href="auto/mlab_figure.html#mayavi.mlab.screenshot" title="mayavi.mlab.screenshot"><code class="xref py py-func docutils literal notranslate"><span class="pre">screenshot()</span></code></a> can
...
pressing <code class="docutils literal notranslate"><span class="pre">Control-r</span></code>.  It can also be executed during the start of the
Mayavi application using the <code class="docutils literal notranslate"><span class="pre">-x</span></code> command line switch.</p>
...
<a class="reference internal" href="auto/mlab_other_functions.html#mayavi.mlab.show" title="mayavi.mlab.show"><code class="xref py py-func docutils literal notranslate"><span class="pre">show()</span></code></a> function (as shown in the <a class="reference external" href=":ref:`mlab-demo`">demo</a> above) to pause your script
and have the user interact with the figure.</p>
<p>You can also use <a class="reference internal" href="auto/mlab_other_functions.html#mayavi.mlab.show" title="mayavi.mlab.show"><code class="xref py py-func docutils literal notranslate"><span class="pre">show()</span></code></a> to decorate a function, and have it run in
...
<span class="nd">@mlab</span><span class="o">.</span><span class="n">show</span>
...
<a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.surf" title="mayavi.mlab.surf"><code class="xref py py-func docutils literal notranslate"><span class="pre">surf()</span></code></a>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">numpy</span> <span class="k">as</span> <span class="nn">np</span>
...
or engineering.</p>
<dl class="field-list">
<dt class="field-odd">Unconnected sources</dt>
...
<a class="reference internal image-reference" href="_images/enthought_mayavi_mlab_quiver3d1.jpg"><img alt="_images/enthought_mayavi_mlab_quiver3d1.jpg" src="_images/enthought_mayavi_mlab_quiver3d1.jpg" style="width: 135.20000000000002px; height: 141.6px;" /></a>
</li>
</ul>
</td></tr></table>
</dd>
<dt class="field-even">implicitly-connected sources</dt>
...
<a class="reference internal image-reference" href="_images/enthought_mayavi_mlab_imshow1.jpg"><img alt="_images/enthought_mayavi_mlab_imshow1.jpg" src="_images/enthought_mayavi_mlab_imshow1.jpg" style="width: 180.0px; height: 116.10000000000001px;" /></a>
</li>
</ul>
</td></tr></table>
</dd>
<dt class="field-odd">Explicitly-connected sources</dt>
<dd class="field-odd"><table class="hlist"><tr><td><ul>
...
following field:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">numpy</span> <span class="k">as</span> <span class="nn">np</span>
<span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">z</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">ogrid</span><span class="p">[</span><span class="o">-</span><span class="mi">10</span><span class="p">:</span><span class="mi">10</span><span class="p">:</span><span class="mi">20</span><span class="n">j</span><span class="p">,</span> <span class="o">-</span><span class="mi">10</span><span class="p">:</span><span class="mi">10</span><span class="p">:</span><span class="mi">20</span><span class="n">j</span><span class="p">,</span> <span class="o">-</span><span class="mi">10</span><span class="p">:</span><span class="mi">10</span><span class="p">:</span><span class="mi">20</span><span class="n">j</span><span class="p">]</span>
...
<dl class="field-list">
<dt class="field-odd">Iso-Surfaces</dt>
<dd class="field-odd"><p>To display iso surfaces of the field, the simplest solution is
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mlab</span><span class="o">.</span><span class="n">contour3d</span><span class="p">(</span><span class="n">s</span><span class="p">)</span>
</pre></div>
</div>
...
<dt class="field-even">Volume rendering</dt>
<dd class="field-even"><p>Volume rendering is an advanced technique in which each voxel is
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">volume</span><span class="p">(</span><span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">scalar_field</span><span class="p">(</span><span class="n">s</span><span class="p">))</span>
</pre></div>
</div>
...
transparent:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">volume</span><span class="p">(</span><span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">scalar_field</span><span class="p">(</span><span class="n">s</span><span class="p">),</span> <span class="n">vmin</span><span class="o">=</span><span class="mi">0</span><span class="p">,</span> <span class="n">vmax</span><span class="o">=</span><span class="mf">0.8</span><span class="p">)</span>
</pre></div>
</div>
...
<dl class="field-list">
<dt class="field-odd">Cut planes</dt>
<dd class="field-odd"><p>While less impressive, cut planes are a very informative way of
visualizing the details of a scalar field:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">image_plane_widget</span><span class="p">(</span><span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">scalar_field</span><span class="p">(</span><span class="n">s</span><span class="p">),</span>
                            <span class="n">plane_orientation</span><span class="o">=</span><span class="s1">&#39;x_axes&#39;</span><span class="p">,</span>
...
<span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">image_plane_widget</span><span class="p">(</span><span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">scalar_field</span><span class="p">(</span><span class="n">s</span><span class="p">),</span>
                            <span class="n">plane_orientation</span><span class="o">=</span><span class="s1">&#39;y_axes&#39;</span><span class="p">,</span>
                            <span class="n">slice_index</span><span class="o">=</span><span class="mi">10</span><span class="p">,</span>
                        <span class="p">)</span>
...
the <code class="docutils literal notranslate"><span class="pre">mlab</span></code> <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.volume_slice" title="mayavi.mlab.volume_slice"><code class="xref py py-func docutils literal notranslate"><span class="pre">volume_slice()</span></code></a> function:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mlab</span><span class="o">.</span><span class="n">volume_slice</span><span class="p">(</span><span class="n">s</span><span class="p">,</span> <span class="n">plane_orientation</span><span class="o">=</span><span class="s1">&#39;x_axes&#39;</span><span class="p">,</span> <span class="n">slice_index</span><span class="o">=</span><span class="mi">10</span><span class="p">)</span>
</pre></div>
</div>
...
<dt class="field-even">A combination of techniques</dt>
<dd class="field-even"><p>Finally, it can be interesting to combine cut planes with
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">src</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">scalar_field</span><span class="p">(</span><span class="n">s</span><span class="p">)</span>
...
instead of using <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.contour3d" title="mayavi.mlab.contour3d"><code class="xref py py-func docutils literal notranslate"><span class="pre">contour3d()</span></code></a> and <a class="reference internal" href="auto/mlab_helper_functions.html#mayavi.mlab.volume_slice" title="mayavi.mlab.volume_slice"><code class="xref py py-func docutils literal notranslate"><span class="pre">volume_slice()</span></code></a>
in order to use a single scalar field as data source.</p>
<p>In some cases, though not in our example, it might be usable to
...
convection cell <a class="footnote-reference brackets" href="#id4" id="id3">1</a>, in hydrodynamics, as defined by its components
sampled on a grid, <cite>u</cite>, <cite>v</cite>, <cite>w</cite>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">numpy</span> <span class="k">as</span> <span class="nn">np</span>
<span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">,</span> <span class="n">z</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">mgrid</span><span class="p">[</span><span class="mi">0</span><span class="p">:</span><span class="mi">1</span><span class="p">:</span><span class="mi">20</span><span class="n">j</span><span class="p">,</span> <span class="mi">0</span><span class="p">:</span><span class="mi">1</span><span class="p">:</span><span class="mi">20</span><span class="n">j</span><span class="p">,</span> <span class="mi">0</span><span class="p">:</span><span class="mi">1</span><span class="p">:</span><span class="mi">20</span><span class="n">j</span><span class="p">]</span>
...
<dl class="field-list">
<dt class="field-odd">Quiver</dt>
<dd class="field-odd"><p>The simplest visualization of a set of vectors, is using the <cite>mlab</cite>
function <cite>quiver3d</cite>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mlab</span><span class="o">.</span><span class="n">quiver3d</span><span class="p">(</span><span class="n">u</span><span class="p">,</span> <span class="n">v</span><span class="p">,</span> <span class="n">w</span><span class="p">)</span>
<span class="n">mlab</span><span class="o">.</span><span class="n">outline</span><span class="p">()</span>
</pre></div>
</div>
...
<dt class="field-even">Masking vectors</dt>
<dd class="field-even"><p>We can use the fact that we are visualizing a vector field, and not
...
point out of 20):</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">src</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">vector_field</span><span class="p">(</span><span class="n">u</span><span class="p">,</span> <span class="n">v</span><span class="p">,</span> <span class="n">w</span><span class="p">)</span>
...
<dt class="field-odd">A cut plane</dt>
<dd class="field-odd"><p>If we are interested in displaying the vectors along a cut, we can
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">vector_cut_plane</span><span class="p">(</span><span class="n">src</span><span class="p">,</span> <span class="n">mask_points</span><span class="o">=</span><span class="mi">2</span><span class="p">,</span> <span class="n">scale_factor</span><span class="o">=</span><span class="mi">3</span><span class="p">)</span>
</pre></div>
</div>
<img alt="_images/vector_field_cut_plane.jpg" src="_images/vector_field_cut_plane.jpg" />
</dd>
<dt class="field-even">Iso-Surfaces of the magnitude</dt>
<dd class="field-even"><p>An important parameter of the vector field is its magnitude. It can
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">magnitude</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">extract_vector_norm</span><span class="p">(</span><span class="n">src</span><span class="p">)</span>
...
<dt class="field-odd">The Flow, or the field lines</dt>
<dd class="field-odd"><p>For certain vector fields, the line of flow along the field can
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">flow</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">flow</span><span class="p">(</span><span class="n">u</span><span class="p">,</span> <span class="n">v</span><span class="p">,</span> <span class="n">w</span><span class="p">,</span> <span class="n">seed_scale</span><span class="o">=</span><span class="mi">1</span><span class="p">,</span>
...
<dt class="field-even">A combination of techniques</dt>
<dd class="field-even"><p>Giving a meaningful visualization of a vector field is a hard task,
...
<span class="c1"># We apply the following modules on the magnitude object, in order to</span>
<span class="c1"># be able to display the norm of the vectors, eg as the color.</span>
...
<span class="n">flow</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">streamline</span><span class="p">(</span><span class="n">magnitude</span><span class="p">,</span> <span class="n">seedtype</span><span class="o">=</span><span class="s1">&#39;plane&#39;</span><span class="p">,</span>
                                        ...
                                        <span class="n">linetype</span><span class="o">=</span><span class="s1">&#39;ribbon&#39;</span><span class="p">,)</span>
...
<img alt="_images/vector_field_combination.jpg" src="_images/vector_field_combination.jpg" />
</dd>
</dl>
<div class="admonition note">
<p class="admonition-title">Note</p>
...
<p>Moreover, the <cite>mlab</cite> functions expose only a small fraction of the
...
<dd><p>Toussaint, V.; Carriere, P. &amp; Raynal, F. A numerical Eulerian
approach to mixing by chaotic advection Phys. Fluids, 1995, 7, 2587</p>
</dd>
</dl>
</div>
</div>
  ...
  <ul>
<li><a class="reference internal" href="#"><code class="docutils literal notranslate"><span class="pre">mlab</span></code>: Python scripting for 3D plotting</a><ul>
...
<li><a class="reference internal" href="#visualizing-a-vector-field">Visualizing a vector field</a></li>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="_sources/mlab.rst.txt"
