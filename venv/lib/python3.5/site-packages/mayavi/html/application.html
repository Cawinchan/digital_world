...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Using the Mayavi application &#8212; mayavi 4.7.1 documentation</title>
...
<ul class="simple">
<li><p><a class="reference internal" href="#tutorial-examples-to-learn-mayavi" id="id6">Tutorial examples to learn Mayavi</a></p></li>
<li><p><a class="reference internal" href="#general-layout-of-ui" id="id7">General layout of UI</a></p></li>
<li><p><a class="reference internal" href="#visualizing-data" id="id8">Visualizing data</a></p></li>
<li><p><a class="reference internal" href="#interaction-with-the-scene" id="id9">Interaction with the scene</a></p></li>
<li><p><a class="reference internal" href="#from-interactive-usage-to-scripting" id="id10">From interactive usage to scripting</a></p></li>
<li><p><a class="reference internal" href="#command-line-arguments" id="id11">Command line arguments</a></p></li>
</ul>
</div>
...
<dl class="field-list">
<dt class="field-odd">Menus</dt>
<dd class="field-odd"><p>The menus let you open files, load modules, set preferences etc.</p>
</dd>
<dt class="field-even">The Mayavi pipeline tree view</dt>
<dd class="field-even"><dl class="simple">
<dt>This is a tree view of the Mayavi pipeline.</dt><dd><ul class="simple">
<li><p>Right click a tree node to rename, delete, copy the objects.</p></li>
<li><p>Left click on a node to edit its properties on the object
editor below the tree.</p></li>
<li><p>It is possible to drag the nodes around on the tree.  For
example it is possible to drag and move a module from one set
of Modules to another, or to move visualization from one
scene to another.</p></li>
</ul>
</dd>
</dl>
</dd>
<dt class="field-odd">The object editor</dt>
<dd class="field-odd"><p>This is where the properties of Mayavi pipeline objects can be
changed when an object on the pipeline is clicked.</p>
</dd>
<dt class="field-even">Mayavi scenes</dt>
<dd class="field-even"><p>This is where the visualization of the data happens.  One can
interact with this scene via the mouse and the keyboard.  More
details are in the following sections.</p>
</dd>
<dt class="field-odd">Python interpreter</dt>
<dd class="field-odd"><p>The built-in Python interpreter that can be used to script Mayavi
...
<dt class="field-even">Logger</dt>
<dd class="field-even"><p>Application log messages may be seen here.</p>
</dd>
</dl>
<p>Mayavi’s UI layout is highly configurable:</p>
<blockquote>
<div><ul class="simple">
<li><p>the line in-between the sections can be dragged to resize
particular views.</p></li>
<li><p>most of the “tabs” on the widgets can be dragged around to move
them anywhere in the application.</p></li>
<li><p>Each view area (the Mayavi pipeline view, object editor, python shell
and logger) can be enabled and disabled in the ‘View’ menu.</p></li>
</ul>
</div></blockquote>
...
<blockquote>
<div><ul class="simple">
<li><p>Buttons to set the view to view along the positive or negative X,
Y and Z axes or obtain an isometric view.</p></li>
<li><p>A button to turn on parallel projection instead of the default
perspective projection.  This is particularly useful when one is
looking at 2D plots.</p></li>
<li><p>A button to turn on an axes to indicate the x, y and z axes.</p></li>
<li><p>A button to turn on full-screen viewing.  Note that once
full-screen mode is entered one must press ‘q’ or ‘e’ to get back
a normal window.</p></li>
<li><p>A button to save the scene to a variety of image formats.  The
image format to use is determined by the extension provided for
the file.</p></li>
<li><p>A button that provides a UI to configure the scene properties.</p></li>
</ul>
</div></blockquote>
...
<blockquote>
<div><ul class="simple">
<li><p>Camera mode: the default, where the camera is operated on with
mouse moves.  This mode is activated by pressing the ‘c’ key.</p></li>
<li><p>Actor mode: in this mode the mouse actions operate on the actor
...
<blockquote>
<div><ul>
<li><p>holding the left mouse button down and dragging will rotate the
camera/actor in the direction moved.</p>
<blockquote>
<div><ul class="simple">
<li><p>Holding down “SHIFT” when doing this will pan the scene –
just like the middle button.</p></li>
<li><p>Holding down “CONTROL” will rotate around the camera’s axis
(roll).</p></li>
<li><p>Holding down “SHIFT” and “CONTROL” and dragging up will zoom
in and dragging down will zoom out.  This is like the right
button.</p></li>
</ul>
</div></blockquote>
</li>
<li><p>holding the right mouse button down and dragging upwards will zoom
in (or increase the actors scale) and dragging downwards will zoom
out (or reduce scale).</p></li>
<li><p>holding the middle mouse button down and dragging will pan the
scene or translate the object.</p></li>
<li><p>Rotating the mouse wheel upwards will zoom in and downwards will
zoom out.</p></li>
</ul>
</div></blockquote>
</div>
...
<dd class="field-even"><p>Use actor mode for mouse interaction instead of camera mode.</p>
</dd>
<dt class="field-odd">‘c’</dt>
<dd class="field-odd"><p>Use camera mode for mouse interaction instead of actor mode.</p>
</dd>
<dt class="field-even">‘e’/’q’/’Esc’</dt>
<dd class="field-even"><p>Exit full-screen mode.</p>
</dd>
<dt class="field-odd">‘f’</dt>
<dd class="field-odd"><p>Move camera’s focal point to current mouse location.  This
will move the camera focus to center the view at the current mouse
position.</p>
</dd>
<dt class="field-even">‘j’</dt>
<dd class="field-even"><p>Use joystick mode for the mouse interaction.  In joystick mode
...
<dd class="field-odd"><p>Configure the lights that are illumining the scene.  This will
pop-up a window to change the light configuration.</p>
</dd>
<dt class="field-even">‘p’</dt>
<dd class="field-even"><p>Pick the data at the current mouse point.  This will pop-up a
...
<dd class="field-odd"><p>Reset the camera focal point and position.  This is very handy.</p>
</dd>
<dt class="field-even">‘s’</dt>
<dd class="field-even"><p>Save the scene to an image, this will first popup a file
...
<dd class="field-odd"><p>Use trackball mode for the mouse interaction.  This is the
default mode for the mouse interaction.</p>
</dd>
<dt class="field-even">‘=’/’+’</dt>
<dd class="field-even"><p>Zoom in.</p>
</dd>
<dt class="field-odd">‘-‘</dt>
<dd class="field-odd"><p>Zoom out.</p>
</dd>
<dt class="field-even">‘left’/’right’/’up’/’down’ arrows</dt>
<dd class="field-even"><p>Pressing the left, right, up and
...
<blockquote>
<div><ul>
<li><p>The name <code class="docutils literal notranslate"><span class="pre">mayavi</span></code> is automatically bound to the
<code class="docutils literal notranslate"><span class="pre">mayavi.script.Script</span></code> instance.  This may be used to
easily script Mayavi.</p></li>
<li><p>The name <code class="docutils literal notranslate"><span class="pre">application</span></code> is bound to the envisage application.</p></li>
<li><p>If a Python file is opened via the <code class="docutils literal notranslate"><span class="pre">File-&gt;Open</span> <span class="pre">File...</span></code> menu item
...
<code class="docutils literal notranslate"><span class="pre">Control-n</span></code> and <code class="docutils literal notranslate"><span class="pre">Control-s</span></code>.</p></li>
<li><p>As mentioned earlier, one may drag and drop nodes from the Mayavi
...
<blockquote>
<div><ul class="simple">
<li><p>record all actions performed on the Mayavi UI into a <em>human readable</em>,
Python script that should be able to recreate your visualization.</p></li>
<li><p>learn how to script the Mayavi objects, in combination with
<a class="reference internal" href="mlab.html#simple-scripting-with-mlab"><span class="std std-ref">mlab</span></a>.</p></li>
</ul>
</div></blockquote>
<p>Here is how you can use this feature:</p>
<blockquote>
<div><ol class="arabic">
<li><p>When you start the <code class="docutils literal notranslate"><span class="pre">mayavi2</span></code> application, on the pipeline tree view
...
<a class="reference internal" href="mlab_changing_object_looks.html#mlab-changing-objects-interactively"><span class="std std-ref">Mayavi pipeline window</span></a>.</p></li>
<li><p>You’ll see a window popup with a few lines of boilerplate code so
...
<code class="docutils literal notranslate"><span class="pre">Save</span> <span class="pre">script</span></code> button, which will be used when you are finished.</p></li>
<li><p>Now do anything you please on the UI.  As you perform those actions,
...
the tree view.</p></li>
<li><p>Move the camera on the UI, rotate the camera, zoom, pan.  All of
...
<li><p>Once you are done, clicking on the record icon again will stop the
...
and not saving a file you may click cancel at this point.</p></li>
<li><p>Close the recorder window. You can quit Mayavi, if you want to.</p></li>
<li><p>Now from the shell do:</p>
...
<p>You should also be able to delete/drag drop objects on the Mayavi
...
<ul class="simple">
<li><dl class="simple">
<dt>On the scene, the ‘c’/’t’/’j’/’a’/’p’ keys are not recorded</dt><dd><p>correctly since this is much more complicated to implement and
typically not necessary for basic scripting.</p>
</dd>
</dl>
</li>
<li><dl class="simple">
<dt>Arbitrary scripting of the interface is obviously not going to work</dt><dd><p>as you may expect.</p>
</dd>
</dl>
</li>
<li><dl class="simple">
<dt>Only trait changes and specific calls are recorded explicitly in the</dt><dd><p>code.  So calling arbitrary methods on arbitrary Mayavi objects will
not record anything typically.</p>
</dd>
</dl>
</li>
</ul>
...
<dd><p>This prints all the available command line options and exits.
Also available through <code class="docutils literal notranslate"><span class="pre">--help</span></code>.</p>
</dd>
<dt><kbd><span class="option">-V</span></kbd></dt>
<dd><p>This prints the Mayavi version on the command line and exits.
Also available through <code class="docutils literal notranslate"><span class="pre">--version</span></code>.</p>
</dd>
<dt><kbd><span class="option">-z <var>file_name</var></span></kbd></dt>
<dd><p>This loads a previously saved Mayavi2 visualization.  Also
...
<span class="pre">file_name</span></code>.</p>
</dd>
<dt><kbd><span class="option">-d <var>data_file</var></span></kbd></dt>
<dd><p>Opens any of the supported data file formats or non-file
...
supported.</p>
<p>Note that <code class="docutils literal notranslate"><span class="pre">data_file</span></code> can also be a source object not associated
...
<dt><kbd><span class="option">-m <var>module-name</var></span></kbd></dt>
<dd><p>A module is an object that actually visualizes the data.  The
...
<p>In this example <code class="docutils literal notranslate"><span class="pre">Outline</span></code> is a standard module and
...
<dt><kbd><span class="option">-f <var>filter-name</var></span></kbd></dt>
<dd><p>A filter is an object that filters out the data in some way or
...
<p>In this example <code class="docutils literal notranslate"><span class="pre">ExtractVectorNorm</span></code> is a standard filter and
...
<dd><p>Starts up a new module manager on the Mayavi pipeline. Also
available through <code class="docutils literal notranslate"><span class="pre">--module-mgr</span></code>.</p>
</dd>
<dt><kbd><span class="option">-n</span></kbd></dt>
<dd><p>Creates a new window/scene. Any options passed after this will
apply to this newly created scene.  Also available through
<code class="docutils literal notranslate"><span class="pre">--new-window</span></code>.</p>
</dd>
<dt><kbd><span class="option">-o</span></kbd></dt>
<dd><p>Run Mayavi in off-screen mode without any graphical user interface.
...
available through, <code class="docutils literal notranslate"><span class="pre">--off-screen</span></code>.</p>
</dd>
<dt><kbd><span class="option">-x <var>script-file</var></span></kbd></dt>
<dd><p>This executes the given script in a namespace where we guarantee
...
<dd><p>Runs the Mayavi test suite and exits.  If run as such, this runs
...
<p>will run the integration tests from the Mayavi sources.  Also
available as <code class="docutils literal notranslate"><span class="pre">--test</span></code>.</p>
</dd>
<dt><kbd><span class="option">-s <var>python-expression</var></span></kbd></dt>
<dd><p>Execute the python-expression on the last created object.  For
...
<p>You should use quotes for the expression.  This is also available
through <code class="docutils literal notranslate"><span class="pre">--set</span></code>.</p>
</dd>
</dl>
<div class="admonition warning">
<p class="admonition-title">Warning</p>
<p>Note that <code class="docutils literal notranslate"><span class="pre">-x</span></code> or <code class="docutils literal notranslate"><span class="pre">--exec</span></code> uses <cite>execfile</cite>, so this can be
