...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>A demo &#8212; mayavi 4.7.1 documentation</title>
...
<span id="mlab-demo"></span><h1>A demo<a class="headerlink" href="#a-demo" title="Permalink to this headline">¶</a></h1>
...
<p>The visualization is created by the single function <code class="xref py py-func docutils literal notranslate"><span class="pre">mesh()</span></code> in the above.</p>
...
IPython via the handy <cite>mlab.test_contour3d??</cite>.</p>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="_sources/mlab_demo.rst.txt"
