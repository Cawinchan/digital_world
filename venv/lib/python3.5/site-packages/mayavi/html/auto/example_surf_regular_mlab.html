...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Surf regular mlab example &#8212; mayavi 4.7.1 documentation</title>
    ...
    <link rel="next" title="Glyph example" href="example_glyph.html" />
    <link rel="prev" title="Offscreen example" href="example_offscreen.html" />
<style type="text/css">
  body {
  ...
  <div class="section" id="surf-regular-mlab-example">
<span id="example-surf-regular-mlab"></span><h1>Surf regular mlab example<a class="headerlink" href="#surf-regular-mlab-example" title="Permalink to this headline">¶</a></h1>
<p>Shows how to view data created by <cite>tvtk.tools.mlab</cite> with
mayavi2.</p>
<p><strong>Python source code:</strong> <a class="reference download internal" download="" href="../_downloads/1d624d91a2e6eeb1782ab9fdaceeb869/surf_regular_mlab.py"><code class="xref download docutils literal notranslate"><span class="pre">surf_regular_mlab.py</span></code></a></p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>
<span class="c1"># Author: Prabhu Ramachandran &lt;prabhu@aero.iitb.ac.in&gt;</span>
<span class="c1"># Copyright (c) 2006-2007, Enthought Inc.</span>
...
<span class="kn">from</span> <span class="nn">tvtk.tools</span> <span class="k">import</span> <span class="n">mlab</span>
...
<span class="k">def</span> <span class="nf">make_data</span><span class="p">():</span>
    <span class="sd">&quot;&quot;&quot;Make some test numpy data and create a TVTK data object from it</span>
<span class="sd">    that we will visualize.</span>
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="k">def</span> <span class="nf">f</span><span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">y</span><span class="p">):</span>
        <span class="sd">&quot;&quot;&quot;Some test function.</span>
<span class="sd">        &quot;&quot;&quot;</span>
...
<span class="k">def</span> <span class="nf">add_data</span><span class="p">(</span><span class="n">tvtk_data</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;Add a TVTK data object `tvtk_data` to the mayavi pipleine.</span>
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="n">d</span> <span class="o">=</span> <span class="n">VTKDataSource</span><span class="p">()</span>
    <span class="n">d</span><span class="o">.</span><span class="n">data</span> <span class="o">=</span> <span class="n">tvtk_data</span>
...
<span class="k">def</span> <span class="nf">surf_regular</span><span class="p">():</span>
    <span class="sd">&quot;&quot;&quot;Now visualize the data as done in mlab.</span>
<span class="sd">    &quot;&quot;&quot;</span>
...
<span class="k">def</span> <span class="nf">main</span><span class="p">():</span>
    ...
    <span class="n">d</span> <span class="o">=</span> <span class="n">make_data</span><span class="p">()</span>
    <span class="n">add_data</span><span class="p">(</span><span class="n">d</span><span class="p">)</span>
    <span class="n">surf_regular</span><span class="p">()</span>
...
<span class="k">if</span> <span class="vm">__name__</span> <span class="o">==</span> <span class="s1">&#39;__main__&#39;</span><span class="p">:</span>
  ...
  <p class="topless"><a href="example_offscreen.html"
                        title="previous chapter">Offscreen example</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="example_glyph.html"
                        title="next chapter">Glyph example</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/auto/example_surf_regular_mlab.rst.txt"
