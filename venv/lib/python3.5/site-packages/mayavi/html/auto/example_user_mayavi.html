...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>User mayavi example &#8212; mayavi 4.7.1 documentation</title>
...
<span class="c1"># Copyright (c) 2006-2008, Enthought, Inc.</span>
<span class="c1"># License: BSD Style.</span>

<span class="kn">from</span> <span class="nn">mayavi.core.registry</span> <span class="k">import</span> <span class="n">registry</span>
<span class="kn">from</span> <span class="nn">mayavi.core.pipeline_info</span> <span class="k">import</span> <span class="n">PipelineInfo</span>
<span class="kn">from</span> <span class="nn">mayavi.core.metadata</span> <span class="k">import</span> <span class="n">ModuleMetadata</span>
...
<span class="kn">from</span> <span class="nn">traits.api</span> <span class="k">import</span> <span class="n">HasTraits</span><span class="p">,</span> <span class="n">Range</span><span class="p">,</span> <span class="n">Button</span><span class="p">,</span> <span class="n">Instance</span><span class="p">,</span> <span class="n">List</span>
<span class="kn">from</span> <span class="nn">traitsui.api</span> <span class="k">import</span> <span class="n">Item</span><span class="p">,</span> <span class="n">View</span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="k">def</span> <span class="nf">get_mayavi</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="kn">from</span> <span class="nn">mayavi.plugins.script</span> <span class="k">import</span> <span class="n">Script</span>
...
<span class="kn">from</span> <span class="nn">envisage.api</span> <span class="k">import</span> <span class="n">Plugin</span><span class="p">,</span> <span class="n">ServiceOffer</span>
...
<span class="k">if</span> <span class="vm">__name__</span> <span class="o">==</span> <span class="s1">&#39;__main__&#39;</span><span class="p">:</span>
    ...
    <span class="kn">from</span> <span class="nn">traits.util.home_directory</span> <span class="k">import</span> <span class="n">get_home_directory</span>
