...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Multiple engines example &#8212; mayavi 4.7.1 documentation</title>
...
<style type="text/css">
  ...
  <div class="section" id="multiple-engines-example">
<span id="example-multiple-engines"></span><h1>Multiple engines example<a class="headerlink" href="#multiple-engines-example" title="Permalink to this headline">¶</a></h1>
...
<p>This example shows how to explicitely set the engine for an embedded
scene.</p>
<p>To define default arguments, it makes use of the Traits initialization
style, rather than overridding the __init__.</p>
...
<span class="c1">################################################################################</span>
<span class="k">class</span> <span class="nc">MyApp</span><span class="p">(</span><span class="n">HasTraits</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">_scene1_default</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">_scene2_default</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">populate_scene1</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">populate_scene2</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
