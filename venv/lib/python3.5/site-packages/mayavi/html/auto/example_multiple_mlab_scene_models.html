...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Multiple mlab scene models example &#8212; mayavi 4.7.1 documentation</title>
    ...
    <link rel="next" title="Superquad with gui example" href="example_superquad_with_gui.html" />
...
<blockquote>
<div><p>Example showing a dialog with multiple embedded scenes.</p>
</div></blockquote>
...
the examples <a class="reference internal" href="example_mlab_interactive_dialog.html#example-mlab-interactive-dialog"><span class="std std-ref">Mlab interactive dialog example</span></a>, and
<a class="reference internal" href="example_lorenz_ui.html#example-lorenz-ui"><span class="std std-ref">Lorenz ui example</span></a>, as well as the section of the user manual
...
<p><strong>Python source code:</strong> <a class="reference download internal" download="" href="../_downloads/c8332cfaa2cbaede2579049132972957/multiple_mlab_scene_models.py"><code class="xref download docutils literal notranslate"><span class="pre">multiple_mlab_scene_models.py</span></code></a></p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">numpy</span> <span class="k">as</span> <span class="nn">np</span>

<span class="kn">from</span> <span class="nn">traits.api</span> <span class="k">import</span> <span class="n">HasTraits</span><span class="p">,</span> <span class="n">Instance</span><span class="p">,</span> <span class="n">Button</span><span class="p">,</span> \
...
<span class="k">class</span> <span class="nc">MyDialog</span><span class="p">(</span><span class="n">HasTraits</span><span class="p">):</span>
    ...
    <span class="n">button1</span> <span class="o">=</span> <span class="n">Button</span><span class="p">(</span><span class="s1">&#39;Redraw&#39;</span><span class="p">)</span>
    <span class="n">button2</span> <span class="o">=</span> <span class="n">Button</span><span class="p">(</span><span class="s1">&#39;Redraw&#39;</span><span class="p">)</span>

    <span class="nd">@on_trait_change</span><span class="p">(</span><span class="s1">&#39;button1&#39;</span><span class="p">)</span>
    ...
    <span class="nd">@on_trait_change</span><span class="p">(</span><span class="s1">&#39;button2&#39;</span><span class="p">)</span>
    ...
    <span class="k">def</span> <span class="nf">redraw_scene</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">scene</span><span class="p">):</span>
        <span class="c1"># Notice how each mlab call points explicitely to the figure it</span>
        <span class="c1"># applies to.</span>
    ...
    <span class="n">view</span> <span class="o">=</span> <span class="n">View</span><span class="p">(</span><span class="n">HSplit</span><span class="p">(</span>
                  <span class="n">Group</span><span class="p">(</span>
                       <span class="n">Item</span><span class="p">(</span><span class="s1">&#39;scene1&#39;</span><span class="p">,</span>
                       ...
                       <span class="s1">&#39;button1&#39;</span><span class="p">,</span>
                       <span class="n">show_labels</span><span class="o">=</span><span class="kc">False</span><span class="p">,</span>
                  <span class="p">),</span>
                  <span class="n">Group</span><span class="p">(</span>
                       <span class="n">Item</span><span class="p">(</span><span class="s1">&#39;scene2&#39;</span><span class="p">,</span>
                            <span class="n">editor</span><span class="o">=</span><span class="n">SceneEditor</span><span class="p">(),</span> <span class="n">height</span><span class="o">=</span><span class="mi">250</span><span class="p">,</span>
                            <span class="n">width</span><span class="o">=</span><span class="mi">300</span><span class="p">,</span> <span class="n">show_label</span><span class="o">=</span><span class="kc">False</span><span class="p">),</span>
                       <span class="s1">&#39;button2&#39;</span><span class="p">,</span>
                       <span class="n">show_labels</span><span class="o">=</span><span class="kc">False</span><span class="p">,</span>
                  <span class="p">),</span>
                <span class="p">),</span>
...
<span class="n">m</span><span class="o">.</span><span class="n">configure_traits</span><span class="p">()</span>
  ...
  <p class="topless"><a href="example_superquad_with_gui.html"
                        title="next chapter">Superquad with gui example</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/auto/example_multiple_mlab_scene_models.rst.txt"
