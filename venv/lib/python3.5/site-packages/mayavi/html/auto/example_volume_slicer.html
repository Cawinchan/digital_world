...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Volume slicer example &#8212; mayavi 4.7.1 documentation</title>
...
<p><strong>Python source code:</strong> <a class="reference download internal" download="" href="../_downloads/5c8c1c090b128ed1fa42e78836016714/volume_slicer.py"><code class="xref download docutils literal notranslate"><span class="pre">volume_slicer.py</span></code></a></p>
...
<span class="kn">from</span> <span class="nn">traits.api</span> <span class="k">import</span> <span class="n">HasTraits</span><span class="p">,</span> <span class="n">Instance</span><span class="p">,</span> <span class="n">Array</span><span class="p">,</span> \
    <span class="n">on_trait_change</span>
<span class="kn">from</span> <span class="nn">traitsui.api</span> <span class="k">import</span> <span class="n">View</span><span class="p">,</span> <span class="n">Item</span><span class="p">,</span> <span class="n">HGroup</span><span class="p">,</span> <span class="n">Group</span>

<span class="kn">from</span> <span class="nn">tvtk.api</span> <span class="k">import</span> <span class="n">tvtk</span>
<span class="kn">from</span> <span class="nn">tvtk.pyface.scene</span> <span class="k">import</span> <span class="n">Scene</span>

<span class="kn">from</span> <span class="nn">mayavi</span> <span class="k">import</span> <span class="n">mlab</span>
<span class="kn">from</span> <span class="nn">mayavi.core.api</span> <span class="k">import</span> <span class="n">PipelineBase</span><span class="p">,</span> <span class="n">Source</span>
<span class="kn">from</span> <span class="nn">mayavi.core.ui.api</span> <span class="k">import</span> <span class="n">SceneEditor</span><span class="p">,</span> <span class="n">MayaviScene</span><span class="p">,</span> \
...
<span class="k">class</span> <span class="nc">VolumeSlicer</span><span class="p">(</span><span class="n">HasTraits</span><span class="p">):</span>
    ...
    <span class="n">data_src3d</span> <span class="o">=</span> <span class="n">Instance</span><span class="p">(</span><span class="n">Source</span><span class="p">)</span>
    ...
    <span class="c1">#---------------------------------------------------------------------------</span>
    <span class="k">def</span> <span class="nf">_data_src3d_default</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
    ...
    <span class="k">def</span> <span class="nf">make_ipw_3d</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">axis_name</span><span class="p">):</span>
        <span class="n">ipw</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">image_plane_widget</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">data_src3d</span><span class="p">,</span>
                        <span class="n">figure</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">scene3d</span><span class="o">.</span><span class="n">mayavi_scene</span><span class="p">,</span>
    ...
    <span class="c1">#---------------------------------------------------------------------------</span>
    <span class="c1"># Scene activation callbaks</span>
    <span class="c1">#---------------------------------------------------------------------------</span>
    ...
    <span class="k">def</span> <span class="nf">display_scene3d</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="n">outline</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">outline</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">data_src3d</span><span class="p">,</span>
                        <span class="n">figure</span><span class="o">=</span><span class="bp">self</span><span class="o">.</span><span class="n">scene3d</span><span class="o">.</span><span class="n">mayavi_scene</span><span class="p">,</span>
                        <span class="p">)</span>
        ...
        <span class="k">for</span> <span class="n">ipw</span> <span class="ow">in</span> <span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">ipw_3d_x</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">ipw_3d_y</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">ipw_3d_z</span><span class="p">):</span>
            <span class="c1"># Turn the interaction off</span>
    ...
    <span class="k">def</span> <span class="nf">make_side_view</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">axis_name</span><span class="p">):</span>
        ...
        <span class="c1"># To avoid copying the data, we take a reference to the</span>
        <span class="c1"># raw VTK dataset, and pass it on to mlab. Mlab will create</span>
        <span class="c1"># a Mayavi source from the VTK without copying it.</span>
        <span class="c1"># We have to specify the figure so that the data gets</span>
        <span class="c1"># added on the figure we are interested in.</span>
        <span class="n">outline</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">outline</span><span class="p">(</span>
                            <span class="bp">self</span><span class="o">.</span><span class="n">data_src3d</span><span class="o">.</span><span class="n">mlab_source</span><span class="o">.</span><span class="n">dataset</span><span class="p">,</span>
        ...
        <span class="c1"># Synchronize positions between the corresponding image plane</span>
        <span class="c1"># widgets on different views.</span>
        <span class="n">ipw</span><span class="o">.</span><span class="n">ipw</span><span class="o">.</span><span class="n">sync_trait</span><span class="p">(</span><span class="s1">&#39;slice_position&#39;</span><span class="p">,</span>
                            <span class="nb">getattr</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="s1">&#39;ipw_3d_</span><span class="si">%s</span><span class="s1">&#39;</span><span class="o">%</span> <span class="n">axis_name</span><span class="p">)</span><span class="o">.</span><span class="n">ipw</span><span class="p">)</span>
        ...
        <span class="k">def</span> <span class="nf">move_view</span><span class="p">(</span><span class="n">obj</span><span class="p">,</span> <span class="n">evt</span><span class="p">):</span>
            <span class="n">position</span> <span class="o">=</span> <span class="n">obj</span><span class="o">.</span><span class="n">GetCurrentCursorPosition</span><span class="p">()</span>
            <span class="k">for</span> <span class="n">other_axis</span><span class="p">,</span> <span class="n">axis_number</span> <span class="ow">in</span> <span class="bp">self</span><span class="o">.</span><span class="n">_axis_names</span><span class="o">.</span><span class="n">items</span><span class="p">():</span>
                <span class="k">if</span> <span class="n">other_axis</span> <span class="o">==</span> <span class="n">axis_name</span><span class="p">:</span>
                    <span class="k">continue</span>
                <span class="n">ipw3d</span> <span class="o">=</span> <span class="nb">getattr</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="s1">&#39;ipw_3d_</span><span class="si">%s</span><span class="s1">&#39;</span> <span class="o">%</span> <span class="n">other_axis</span><span class="p">)</span>
                <span class="n">ipw3d</span><span class="o">.</span><span class="n">ipw</span><span class="o">.</span><span class="n">slice_position</span> <span class="o">=</span> <span class="n">position</span><span class="p">[</span><span class="n">axis_number</span><span class="p">]</span>
        ...
        <span class="c1"># Position the view for the scene</span>
        <span class="n">views</span> <span class="o">=</span> <span class="nb">dict</span><span class="p">(</span><span class="n">x</span><span class="o">=</span><span class="p">(</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">90</span><span class="p">),</span>
                     <span class="n">y</span><span class="o">=</span><span class="p">(</span><span class="mi">90</span><span class="p">,</span> <span class="mi">90</span><span class="p">),</span>
                     <span class="n">z</span><span class="o">=</span><span class="p">(</span> <span class="mi">0</span><span class="p">,</span>  <span class="mi">0</span><span class="p">),</span>
                     <span class="p">)</span>
        <span class="n">scene</span><span class="o">.</span><span class="n">mlab</span><span class="o">.</span><span class="n">view</span><span class="p">(</span><span class="o">*</span><span class="n">views</span><span class="p">[</span><span class="n">axis_name</span><span class="p">])</span>
