...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Datasets example &#8212; mayavi 4.7.1 documentation</title>
    ...
    <link rel="next" title="Delaunay graph example" href="example_delaunay_graph.html" />
    <link rel="prev" title="Tvtk segmentation example" href="example_tvtk_segmentation.html" />
<style type="text/css">
  body {
  ...
  <div class="section" id="datasets-example">
<span id="example-datasets"></span><h1>Datasets example<a class="headerlink" href="#datasets-example" title="Permalink to this headline">¶</a></h1>
<p>A Mayavi example to show the different data sets. See
...
<p>The following images are created:</p>
<table class="hlist"><tr><td><ul>
<li><p><strong>ImageData</strong></p>
<a class="reference internal image-reference" href="../_images/image_data.jpg"><img alt="../_images/image_data.jpg" src="../_images/image_data.jpg" style="width: 200.0px; height: 160.0px;" /></a>
</li>
<li><p><strong>RectilinearGrid</strong></p>
<a class="reference internal image-reference" href="../_images/rectilinear_grid.jpg"><img alt="../_images/rectilinear_grid.jpg" src="../_images/rectilinear_grid.jpg" style="width: 200.0px; height: 160.0px;" /></a>
</li>
</ul>
</td><td><ul>
<li><p><strong>StructuredGrid</strong></p>
<a class="reference internal image-reference" href="../_images/structured_grid.jpg"><img alt="../_images/structured_grid.jpg" src="../_images/structured_grid.jpg" style="width: 200.0px; height: 160.0px;" /></a>
</li>
<li><p><strong>UnstructuredGrid</strong></p>
<a class="reference internal image-reference" href="../_images/unstructured_grid.jpg"><img alt="../_images/unstructured_grid.jpg" src="../_images/unstructured_grid.jpg" style="width: 200.0px; height: 160.0px;" /></a>
</li>
</ul>
</td></tr></table>
<p><strong>Python source code:</strong> <a class="reference download internal" download="" href="../_downloads/f1a1d04d9bd51ec7b93d56e36ccbb713/datasets.py"><code class="xref download docutils literal notranslate"><span class="pre">datasets.py</span></code></a></p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="c1"># Author: Gael Varoquaux &lt;gael dot varoquaux at normalesup.org&gt;</span>
<span class="c1"># Copyright (c) 2008, Enthought, Inc.</span>
<span class="c1"># License: BSD style.</span>

<span class="kn">from</span> <span class="nn">numpy</span> <span class="k">import</span> <span class="n">array</span><span class="p">,</span> <span class="n">random</span><span class="p">,</span> <span class="n">linspace</span><span class="p">,</span> <span class="n">pi</span><span class="p">,</span> <span class="n">ravel</span><span class="p">,</span> <span class="n">cos</span><span class="p">,</span> <span class="n">sin</span><span class="p">,</span> <span class="n">empty</span>
...
<span class="k">def</span> <span class="nf">image_data</span><span class="p">():</span>
...
<span class="k">def</span> <span class="nf">rectilinear_grid</span><span class="p">():</span>
    <span class="n">data</span> <span class="o">=</span> <span class="n">random</span><span class="o">.</span><span class="n">random</span><span class="p">((</span><span class="mi">3</span><span class="p">,</span> <span class="mi">3</span><span class="p">,</span> <span class="mi">3</span><span class="p">))</span>
...
<span class="k">def</span> <span class="nf">structured_grid</span><span class="p">():</span>
...
<span class="k">def</span> <span class="nf">unstructured_grid</span><span class="p">():</span>
...
<span class="k">def</span> <span class="nf">polydata</span><span class="p">():</span>
...
<span class="k">def</span> <span class="nf">view</span><span class="p">(</span><span class="n">dataset</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot; Open up a mayavi scene and display the dataset in it.</span>
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="n">fig</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">figure</span><span class="p">(</span><span class="n">bgcolor</span><span class="o">=</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">1</span><span class="p">,</span> <span class="mi">1</span><span class="p">),</span> <span class="n">fgcolor</span><span class="o">=</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">),</span>
                      <span class="n">figure</span><span class="o">=</span><span class="n">dataset</span><span class="o">.</span><span class="n">class_name</span><span class="p">[</span><span class="mi">3</span><span class="p">:])</span>
    <span class="n">surf</span> <span class="o">=</span> <span class="n">mlab</span><span class="o">.</span><span class="n">pipeline</span><span class="o">.</span><span class="n">surface</span><span class="p">(</span><span class="n">dataset</span><span class="p">,</span> <span class="n">opacity</span><span class="o">=</span><span class="mf">0.1</span><span class="p">)</span>
...
<span class="k">def</span> <span class="nf">main</span><span class="p">():</span>
    <span class="n">view</span><span class="p">(</span><span class="n">image_data</span><span class="p">())</span>
    <span class="n">view</span><span class="p">(</span><span class="n">rectilinear_grid</span><span class="p">())</span>
    <span class="n">view</span><span class="p">(</span><span class="n">structured_grid</span><span class="p">())</span>
    <span class="n">view</span><span class="p">(</span><span class="n">unstructured_grid</span><span class="p">())</span>
    <span class="n">view</span><span class="p">(</span><span class="n">polydata</span><span class="p">())</span>
...
<span class="k">if</span> <span class="vm">__name__</span> <span class="o">==</span> <span class="s1">&#39;__main__&#39;</span><span class="p">:</span>
  ...
  <p class="topless"><a href="example_tvtk_segmentation.html"
                        title="previous chapter">Tvtk segmentation example</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="example_delaunay_graph.html"
                        title="next chapter">Delaunay graph example</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/auto/example_datasets.rst.txt"
