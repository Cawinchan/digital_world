...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Mlab traits ui example &#8212; mayavi 4.7.1 documentation</title>
    ...
    <link rel="next" title="Wx embedding example" href="example_wx_embedding.html" />
    <link rel="prev" title="Mlab visual example" href="example_mlab_visual.html" />
<style type="text/css">
  body {
  ...
  <div class="section" id="mlab-traits-ui-example">
<span id="example-mlab-traits-ui"></span><h1>Mlab traits ui example<a class="headerlink" href="#mlab-traits-ui-example" title="Permalink to this headline">¶</a></h1>
<p>A simple example of how to use mayavi.mlab inside a traits UI dialog.</p>
<p>This example uses traitsUI (
<a class="reference external" href="http://code.enthought.com/projects/traits/">traitsUI</a> ) to create a
the simplest possible dialog: a single Mayavi scene in a window.</p>
<p><strong>Python source code:</strong> <a class="reference download internal" download="" href="../_downloads/c64f12b37a216da7a7fbbba7c612caa4/mlab_traits_ui.py"><code class="xref download docutils literal notranslate"><span class="pre">mlab_traits_ui.py</span></code></a></p>
...
<span class="k">class</span> <span class="nc">ActorViewer</span><span class="p">(</span><span class="n">HasTraits</span><span class="p">):</span>
    ...
    <span class="c1">######################</span>
    <span class="c1"># Using &#39;scene_class=MayaviScene&#39; adds a Mayavi icon to the toolbar,</span>
    <span class="c1"># to pop up a dialog editing the pipeline.</span>
    ...
    <span class="k">def</span> <span class="nf">generate_data</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        ...
        <span class="n">X</span><span class="p">,</span> <span class="n">Y</span> <span class="o">=</span> <span class="n">mgrid</span><span class="p">[</span><span class="o">-</span><span class="mi">2</span><span class="p">:</span><span class="mi">2</span><span class="p">:</span><span class="mi">100</span><span class="n">j</span><span class="p">,</span> <span class="o">-</span><span class="mi">2</span><span class="p">:</span><span class="mi">2</span><span class="p">:</span><span class="mi">100</span><span class="n">j</span><span class="p">]</span>
        ...
        <span class="bp">self</span><span class="o">.</span><span class="n">scene</span><span class="o">.</span><span class="n">mlab</span><span class="o">.</span><span class="n">surf</span><span class="p">(</span><span class="n">X</span><span class="p">,</span> <span class="n">Y</span><span class="p">,</span> <span class="n">Z</span><span class="p">,</span> <span class="n">colormap</span><span class="o">=</span><span class="s1">&#39;gist_earth&#39;</span><span class="p">)</span>
...
<span class="k">if</span> <span class="vm">__name__</span> <span class="o">==</span> <span class="s1">&#39;__main__&#39;</span><span class="p">:</span>
  ...
  <p class="topless"><a href="example_mlab_visual.html"
                        title="previous chapter">Mlab visual example</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="example_wx_embedding.html"
                        title="next chapter">Wx embedding example</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/auto/example_mlab_traits_ui.rst.txt"
