...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Custom colormap example &#8212; mayavi 4.7.1 documentation</title>
    ...
    <link rel="next" title="Surface from irregular data example" href="example_surface_from_irregular_data.html" />
    <link rel="prev" title="Lucy example" href="example_lucy.html" />
<style type="text/css">
  body {
  ...
  .sphinxsidebarwrapper a {
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="example_lucy.html" title="Lucy example"
  ...
  <div class="section" id="custom-colormap-example">
<span id="example-custom-colormap"></span><h1>Custom colormap example<a class="headerlink" href="#custom-colormap-example" title="Permalink to this headline">¶</a></h1>
<p>An example showing how a custom colormap (or look up table) can be used
for a given object.</p>
<p>Although the end user specifies colormaps by giving the name of a set of
...
color defined by its RGBA components.</p>
<p>In this example, we show how the LUT of an object can be retrieved and
modified. Specificaly, we start by giving a surf object the ‘cool’
colormap, but we modify add to add a transparency effect.</p>
<p>Notice in the resulting image how the surface becomes more transparent
for its lower points.</p>
<p>Note that if you want to use a different number of colors, you can
change the ‘number_of_colors’ attribute of the lut object and assign a
new array of the right shape to its ‘table’ attribute.</p>
<img alt="../_images/example_custom_colormap.jpg" class="align-center" src="../_images/example_custom_colormap.jpg" />
<p><strong>Python source code:</strong> <a class="reference download internal" download="" href="../_downloads/6bd0cbc7261b60d0db9d5a50c7e3646b/custom_colormap.py"><code class="xref download docutils literal notranslate"><span class="pre">custom_colormap.py</span></code></a></p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>
<span class="c1"># Create some data</span>
<span class="kn">import</span> <span class="nn">numpy</span> <span class="k">as</span> <span class="nn">np</span>

<span class="n">x</span><span class="p">,</span> <span class="n">y</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">mgrid</span><span class="p">[</span><span class="o">-</span><span class="mi">10</span><span class="p">:</span><span class="mi">10</span><span class="p">:</span><span class="mi">200</span><span class="n">j</span><span class="p">,</span> <span class="o">-</span><span class="mi">10</span><span class="p">:</span><span class="mi">10</span><span class="p">:</span><span class="mi">200</span><span class="n">j</span><span class="p">]</span>
...
<span class="c1"># Visualize it with mlab.surf</span>
...
<span class="c1"># Retrieve the LUT of the surf object.</span>
...
<span class="c1"># We need to force update of the figure now that we have changed the LUT.</span>
<span class="n">mlab</span><span class="o">.</span><span class="n">draw</span><span class="p">()</span>
<span class="n">mlab</span><span class="o">.</span><span class="n">view</span><span class="p">(</span><span class="mi">40</span><span class="p">,</span> <span class="mi">85</span><span class="p">)</span>
...
<span class="n">mlab</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
  ...
  <p class="topless"><a href="example_lucy.html"
                        title="previous chapter">Lucy example</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="example_surface_from_irregular_data.html"
                        title="next chapter">Surface from irregular data example</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/auto/example_custom_colormap.rst.txt"
