...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Plotting many lines example &#8212; mayavi 4.7.1 documentation</title>
...
<span id="example-plotting-many-lines"></span><h1>Plotting many lines example<a class="headerlink" href="#plotting-many-lines-example" title="Permalink to this headline">¶</a></h1>
...
instance <a class="reference internal" href="example_flight_graph.html#example-flight-graph"><span class="std std-ref">Flight graph example</span></a>): create a set of points, and
...
<a class="reference internal" href="../data.html#poly-data"><span class="std std-ref">PolyData</span></a>) using <cite>mlab.pipeline.scalar_scatter</cite>. To add the
...
<p><strong>Python source code:</strong> <a class="reference download internal" download="" href="../_downloads/d56f48600fa39ce43fdf58e4144f2afb/plotting_many_lines.py"><code class="xref download docutils literal notranslate"><span class="pre">plotting_many_lines.py</span></code></a></p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>
<span class="c1"># Author: Gael Varoquaux &lt;gael dot varoquaux at normalesup dot org&gt;</span>
<span class="c1"># Copyright (c) 2010, Enthought</span>
<span class="c1"># License: BSD style</span>

<span class="kn">import</span> <span class="nn">numpy</span> <span class="k">as</span> <span class="nn">np</span>

<span class="c1"># The number of points per line</span>
<span class="n">N</span> <span class="o">=</span> <span class="mi">300</span>

<span class="c1"># The scalar parameter for each line</span>
...
<span class="c1"># We create a list of positions and connections, each describing a line.</span>
<span class="c1"># We will collapse them in one array before plotting.</span>
...
<span class="c1"># The index of the current point in the total amount of points</span>
<span class="n">index</span> <span class="o">=</span> <span class="mi">0</span>

<span class="c1"># Create each line one after the other in a loop</span>
<span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="nb">range</span><span class="p">(</span><span class="mi">50</span><span class="p">):</span>
    ...
    <span class="n">y</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">np</span><span class="o">.</span><span class="n">cos</span><span class="p">((</span><span class="mi">2</span> <span class="o">+</span> <span class="o">.</span><span class="mi">02</span> <span class="o">*</span> <span class="n">i</span><span class="p">)</span> <span class="o">*</span> <span class="n">t</span><span class="p">))</span>
    <span class="n">z</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">np</span><span class="o">.</span><span class="n">cos</span><span class="p">((</span><span class="mi">3</span> <span class="o">+</span> <span class="o">.</span><span class="mi">02</span> <span class="o">*</span> <span class="n">i</span><span class="p">)</span> <span class="o">*</span> <span class="n">t</span><span class="p">))</span>
    <span class="n">s</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">t</span><span class="p">)</span>
    <span class="c1"># This is the tricky part: in a line, each point is connected</span>
    <span class="c1"># to the one following it. We have to express this with the indices</span>
    <span class="c1"># of the final set of points once all lines have been combined</span>
    <span class="c1"># together, this is why we need to keep track of the total number of</span>
    <span class="c1"># points already created (index)</span>
...
<span class="c1"># Now collapse all positions, scalars and connections in big arrays</span>
...
<span class="c1"># Create the points</span>
...
<span class="c1"># The stripper filter cleans up connected lines</span>
...
<span class="c1"># Finally, display the set of lines</span>
...
<span class="c1"># And choose a nice view</span>
<span class="n">mlab</span><span class="o">.</span><span class="n">view</span><span class="p">(</span><span class="mf">33.6</span><span class="p">,</span> <span class="mi">106</span><span class="p">,</span> <span class="mf">5.5</span><span class="p">,</span> <span class="p">[</span><span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="o">.</span><span class="mi">05</span><span class="p">])</span>
...
<span class="n">mlab</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/auto/example_plotting_many_lines.rst.txt"
