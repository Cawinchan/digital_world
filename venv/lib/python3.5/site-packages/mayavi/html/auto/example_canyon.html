...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Canyon example &#8212; mayavi 4.7.1 documentation</title>
    ...
    <link rel="next" title="Julia set decimation example" href="example_julia_set_decimation.html" />
    <link rel="prev" title="Lorenz example" href="example_lorenz.html" />
<style type="text/css">
  body {
  ...
  <div class="section" id="canyon-example">
<span id="example-canyon"></span><h1>Canyon example<a class="headerlink" href="#canyon-example" title="Permalink to this headline">¶</a></h1>
<p>Retrieve radar data from the NASA and plot a view of the Grand Canyon
landscape.</p>
<p>We cannot display the whole data, as it would be too big. To display
more, see the canyon decimation example.</p>
<p>This example is interesting as it shows how numpy can be used to load
and crop data completly foreign to Mayavi.</p>
<img alt="../_images/example_canyon.jpg" class="align-center" src="../_images/example_canyon.jpg" />
<p><strong>Python source code:</strong> <a class="reference download internal" download="" href="../_downloads/a82ca56aa41888d9049106a620ecdf04/canyon.py"><code class="xref download docutils literal notranslate"><span class="pre">canyon.py</span></code></a></p>
...
<span class="c1"># Plot an interesting section #################################################</span>
...
<span class="c1"># Convert missing values into something more sensible.</span>
...
<span class="c1"># The data takes a lot of memory, and the surf command has created a</span>
<span class="c1"># copy. We free the inital memory.</span>
<span class="k">del</span> <span class="n">data</span>

<span class="c1"># A view of the canyon</span>
...
<span class="n">mlab</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
  ...
  <p class="topless"><a href="example_lorenz.html"
                        title="previous chapter">Lorenz example</a></p>
  <h4>Next topic</h4>
  <p class="topless"><a href="example_julia_set_decimation.html"
                        title="next chapter">Julia set decimation example</a></p>
  <div role="note" aria-label="source link">
    <h3>This Page</h3>
    <ul class="this-page-menu">
      <li><a href="../_sources/auto/example_canyon.rst.txt"
