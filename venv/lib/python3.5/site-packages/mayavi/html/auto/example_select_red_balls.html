...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Select red balls example &#8212; mayavi 4.7.1 documentation</title>
...
<span id="example-select-red-balls"></span><h1>Select red balls example<a class="headerlink" href="#select-red-balls-example" title="Permalink to this headline">¶</a></h1>
...
<p><strong>Python source code:</strong> <a class="reference download internal" download="" href="../_downloads/a71f73a01d3d442df043b58323e82346/select_red_balls.py"><code class="xref download docutils literal notranslate"><span class="pre">select_red_balls.py</span></code></a></p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>
<span class="c1"># Author: Gael Varoquaux &lt;gael dot varoquaux at normalesup.org&gt;</span>
...
<span class="c1">################################################################################</span>
<span class="c1"># Disable the rendering, to get bring up the figure quicker:</span>
...
<span class="c1"># Creates two set of points using mlab.points3d: red point and</span>
<span class="c1"># white points</span>
...
<span class="c1"># Add an outline to show the selected point and center it on the first</span>
...
<span class="c1"># Every object has been created, we can reenable the rendering.</span>
...
<span class="c1"># Here, we grab the points describing the individual glyph, to figure</span>
<span class="c1"># out how many points are in an individual glyph.</span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="k">if</span> <span class="n">picker</span><span class="o">.</span><span class="n">actor</span> <span class="ow">in</span> <span class="n">red_glyphs</span><span class="o">.</span><span class="n">actor</span><span class="o">.</span><span class="n">actors</span><span class="p">:</span>
        <span class="c1"># Find which data point corresponds to the point picked:</span>
        <span class="c1"># we have to account for the fact that each data point is</span>
        <span class="c1"># represented by a glyph with several points</span>
        ...
        <span class="c1"># If the no points have been selected, we have &#39;-1&#39;</span>
        <span class="k">if</span> <span class="n">point_id</span> <span class="o">!=</span> <span class="o">-</span><span class="mi">1</span><span class="p">:</span>
            <span class="c1"># Retrieve the coordinnates coorresponding to that data</span>
            ...
            <span class="c1"># Move the outline to the data point.</span>
...
<span class="c1"># Decrease the tolerance, so that we can more easily select a precise</span>
<span class="c1"># point.</span>
<span class="n">picker</span><span class="o">.</span><span class="n">tolerance</span> <span class="o">=</span> <span class="mf">0.01</span>

<span class="n">mlab</span><span class="o">.</span><span class="n">title</span><span class="p">(</span><span class="s1">&#39;Click on red balls&#39;</span><span class="p">)</span>
...
<span class="n">mlab</span><span class="o">.</span><span class="n">show</span><span class="p">()</span>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/auto/example_select_red_balls.rst.txt"
