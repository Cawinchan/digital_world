...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Visualizing rich datasets: the fire_ug.vtu example &#8212; mayavi 4.7.1 documentation</title>
...
<blockquote>
<div><ol class="arabic">
<li><p>With mayavi2 started, select <cite>File-&gt;Load data-&gt;Open file</cite> to load the
...
wish to view.</p></li>
<li><p>Create an outline of the data as described earlier using an
...
module.</p></li>
<li><p>Show the scalar bar that represents the color mapping (via a Look
...
Experiment with the different color maps provided by default.</p></li>
<li><p>Now click on the <cite>VTK XML file …</cite> and select different scalar
values to see how the data has changed.  Your legend should
automatically update when the scalar value is changed.</p></li>
<li><p>This data also features vectors.  The scalar data has <cite>u</cite>, <cite>v</cite>
...
Vector Norm</cite> menu.</p></li>
<li><p>If you now create a <cite>ScalarCutPlane</cite>, you will see a new
...
<li><p>You can filter “filtered data”.  So select the
...
<li><p>There are several vector modules.  <cite>VectorCutPlane</cite>, <cite>Vectors</cite>,
...
initialize the streamline seeds.</p></li>
<li><p>You can view the room in which the fire is taking place by
opening the VRML file by the <cite>File-&gt;Open-&gt;VRML2 file</cite> menu item
and selecting the <code class="docutils literal notranslate"><span class="pre">room_vis.wrl</span></code> file included with the data.</p></li>
<li><p>Once you setup a complex visualization pipeline and want to save
...
However, it does work and can be used for the time being.</p></li>
</ol>
</div></blockquote>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ cd examples
$ python streamline.py
</pre></div>
</div>
<p>or so:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ mayavi2 -x streamline.py
</pre></div>
</div>
